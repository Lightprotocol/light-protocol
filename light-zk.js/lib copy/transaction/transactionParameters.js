...
class TransactionParameters {
    ...
    appUtxo, addInUtxos = true, addOutUtxos = true, verifierIdl, mergeUtxos = false, message, assetLookupTable, verifierProgramLookupTable, separateSolUtxo = false, }) {
        ...
        if (action !== index_1.Action.SHIELD && !(relayer === null || relayer === void 0 ? void 0 : relayer.getRelayerFee(ataCreationFee))) {
    ...
    assignAccounts() {
        ...
        if (this.action.toString() === index_1.Action.UNSHIELD.toString() ||
            ...
            if (!this.accounts.recipientSpl) {
                ...
                if (!((_a = this.publicAmountSpl) === null || _a === void 0 ? void 0 : _a.eq(index_1.BN_0))) {
            ...
            if (!this.accounts.recipientSol) {
                ...
                if (!this.publicAmountSol.eq(index_1.BN_0) &&
                    !((_b = this.publicAmountSol) === null || _b === void 0 ? void 0 : _b.sub(index_1.FIELD_SIZE).mul(new anchor_1.BN(-1)).sub(new anchor_1.BN(this.relayer.getRelayerFee(this.ataCreationFee))).eq(index_1.BN_0))) {
            ...
            if (!this.accounts.senderSpl) {
                ...
                if (!((_c = this.publicAmountSpl) === null || _c === void 0 ? void 0 : _c.eq(index_1.BN_0))) {
