...
class Transaction {
    ...
    async closeVerifierState() {
        ...
        if (this.appParams) {
            const transaction = new web3_js_1.Transaction().add(await ((_a = this.appParams) === null || _a === void 0 ? void 0 : _a.verifier.verifierProgram.methods.closeVerifierState().accounts({
                ...this.params.accounts,
            }).instruction()));
            return await this.provider.wallet.sendAndConfirmTransaction(transaction);
        }
        else {
            const transaction = new web3_js_1.Transaction().add(await index_1.TransactionParameters.getVerifierProgram((_b = this.params) === null || _b === void 0 ? void 0 : _b.verifierIdl, this.provider.provider)
