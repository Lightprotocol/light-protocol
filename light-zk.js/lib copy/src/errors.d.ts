...
export declare enum TokenUtxoBalanceErrorCode {
    UTXO_UNDEFINED = "UTXO_UNDEFINED"
}
export declare enum RelayerErrorCode {
...
export declare enum SolMerkleTreeErrorCode {
    MERKLE_TREE_UNDEFINED = "MERKLE_TREE_UNDEFINED"
}
export declare enum TransactionParametersErrorCode {
...
export declare enum ProgramUtxoBalanceErrorCode {
 ...
 **/
export declare class TransactionError extends MetaError {
}
export declare class TransactionParametersError extends MetaError {
}
/**
...
export declare class AccountError extends MetaError {
}
export declare class RelayerError extends MetaError {
}
export declare class CreateUtxoError extends MetaError {
}
export declare class ProviderError extends MetaError {
}
export declare class SelectInUtxosError extends MetaError {
}
export declare class UserError extends MetaError {
}
export declare class UtilsError extends MetaError {
}
export declare class TokenUtxoBalanceError extends MetaError {
}
export declare class ProgramUtxoBalanceError extends MetaError {
}
