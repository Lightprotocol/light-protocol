...
const tweetnacl_1 = tslib_1.__importStar(require("tweetnacl"));
...
class Utxo {
    ...
    assets = [web3_js_1.SystemProgram.programId], amounts = [index_1.BN_0], account, blinding = new anchor_1.BN(randomBN(), 31, "be"), poolType = index_1.BN_0, verifierAddress = web3_js_1.SystemProgram.programId, index, appDataHash, appData, appDataIdl, includeAppData = true, assetLookupTable, verifierProgramLookupTable, }) {
        ...
        while (i < exports.N_ASSETS) {
            ...
            if ((_a = amount === null || amount === void 0 ? void 0 : amount.lt) === null || _a === void 0 ? void 0 : _a.call(amount, index_1.BN_0)) {
                throw new index_1.UtxoError(index_1.UtxoErrorCode.NEGATIVE_AMOUNT, "constructor", `amount cannot be negative, amounts[${i}] = ${amount !== null && amount !== void 0 ? amount : "undefined"}`);
            }
            i++;
        }
        ...
        if (assets[1].toBase58() === web3_js_1.SystemProgram.programId.toBase58() &&
            !amounts[1].isZero()) {
            throw new index_1.UtxoError(index_1.UtxoErrorCode.POSITIVE_AMOUNT, "constructor", `spl amount cannot be positive, amounts[1] = ${(_b = amounts[1]) !== null && _b !== void 0 ? _b : "undefined"}`);
        }
    ...
    static equal(poseidon, utxo0, utxo1, skipNullifier = false) {
        ...
        chai_1.assert.equal((_a = utxo0.getCommitment(poseidon)) === null || _a === void 0 ? void 0 : _a.toString(), (_b = utxo1.getCommitment(poseidon)) === null || _b === void 0 ? void 0 : _b.toString(), "commitment");
        if (!skipNullifier) {
            if (utxo0.index || utxo1.index) {
                if (utxo0.account.privkey || utxo1.account.privkey) {
                    chai_1.assert.equal((_c = utxo0.getNullifier(poseidon)) === null || _c === void 0 ? void 0 : _c.toString(), (_d = utxo1.getNullifier(poseidon)) === null || _d === void 0 ? void 0 : _d.toString(), "nullifier");
                }
            }
        }
    }
