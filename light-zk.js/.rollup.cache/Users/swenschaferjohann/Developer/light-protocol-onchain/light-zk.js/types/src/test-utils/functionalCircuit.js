import { FEE_ASSET, Account, Provider as LightProvider, MINT, Utxo, Transaction, Action, TransactionParameters, IDL_VERIFIER_PROGRAM_ZERO, } from "../index";
import * as anchor from "@coral-xyz/anchor";
import { assert, expect } from "chai";
import { Keypair as SolanaKeypair } from "@solana/web3.js";
import { bs58 } from "@coral-xyz/anchor/dist/cjs/utils/bytes";
const circomlibjs = require("circomlibjs");
export async function functionalCircuitTest(app = false, verifierIdl) {
