...
export declare const fetchNullifierAccountInfo: (nullifier: string, connection: Connection) => Promise<anchor.web3.AccountInfo<Buffer>>;
export declare const fetchQueuedLeavesAccountInfo: (leftLeaf: Uint8Array, connection: Connection) => Promise<anchor.web3.AccountInfo<Buffer>>;
