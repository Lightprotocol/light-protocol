...
export declare class User {
    ...
    syncState(aes: boolean, balance: Balance | InboxBalance, merkleTreePdaPublicKey: PublicKey): Promise<Balance | InboxBalance>;
    /**
     ...
     */
    syncStorage(idl: anchor.Idl, aes?: boolean): Promise<Map<string, ProgramUtxoBalance>>;
    getAllUtxos(): Utxo[];
    /**
     *
     */
    ...
    getProgramUtxos({ latestBalance, latestInboxBalance, idl, asMap, }: {
        ...
        inboxTokenBalances: Map<string, TokenUtxoBalance>;
