...
export const USER_TOKEN_ACCOUNT = Keypair.fromSecretKey(new Uint8Array([
...
export const RECIPIENT_TOKEN_ACCOUNT = Keypair.fromSecretKey(new Uint8Array([
...
export const MINT = new PublicKey("ycrF6Bw3doNPMSDmZM1rxNHimD2bwq1UFmifMCzbjAe");
...
export const ADMIN_AUTH_KEY = new PublicKey(new Uint8Array(MERKLE_TREE_INIT_AUTHORITY));
export const ADMIN_AUTH_KEYPAIR = Keypair.fromSecretKey(new Uint8Array(PRIVATE_KEY));
export const RELAYER_RECIPIENT_KEYPAIR = Keypair.fromSecretKey(new Uint8Array(PRIVATE_KEY_RELAYER));
export const userTokenAccount = new PublicKey("CfyD2mSomGrjnyMKWrgNEk1ApaaUvKRDsnQngGkCVTFk");
export const recipientTokenAccount = new PublicKey("6RtYrpXTyH98dvTf9ufivkyDG8mF48oMDbhiRW9r5KjD");
