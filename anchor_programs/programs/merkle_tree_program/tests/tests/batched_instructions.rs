...
pub mod batched_instructions {
    ...
    pub fn insert_0_double(
        ...
        verifier_state_data.current_index = (merkle_tree_account.next_index as u64 + verifier_state_data.insert_leaves_index as u64 * 2 ) / 2;
        msg!(
        ...
        verifier_state_data.node_left = verifier_state_data.leaves[verifier_state_data.insert_leaves_index as usize][0];
        verifier_state_data.node_right = verifier_state_data.leaves[verifier_state_data.insert_leaves_index as usize][1];
        println!("verifier_state_data.node_left {:?}", verifier_state_data.node_left);
        println!("verifier_state_data.node_right {:?}", verifier_state_data.node_right);
        ...
        println!("verifier_state_data.insert_leaves_index {}", verifier_state_data.insert_leaves_index);
    ...
    pub fn insert_1_inner_loop(
        ...
        msg!("verifier_state_data.current_index {}", verifier_state_data.current_index);
