...
import { getMockRpc, getTestKeypair } from '../../src/test-utils';
...
describe('Program test', () => {
    ...
    const payer = byteArrayToKeypair([
        122, 239, 192, 18, 21, 29, 237, 120, 104, 95, 247, 150, 181, 218, 207,
        60, 158, 110, 200, 246, 74, 226, 30, 223, 142, 138, 133, 194, 30, 254,
        132, 236, 227, 130, 162, 184, 215, 227, 81, 211, 134, 73, 118, 71, 219,
        163, 243, 41, 118, 21, 155, 87, 11, 53, 153, 130, 178, 126, 151, 86,
        225, 36, 251, 130,
    ]);
    ...
    it.skip('should build ix and send to chain successfully', async () => {
        ...
        tx.message.compiledInstructions[0].accountKeyIndexes.forEach(
            (index, _) => {
                console.log(
