...
/**
 * Create a compression struct for decompressing to light-token ATA
...
/**
 * Create a compression struct for compressing light-token (burn from light-token ATA)
 * Used in unwrap flow: light-token ATA -> pool -> SPL ATA
