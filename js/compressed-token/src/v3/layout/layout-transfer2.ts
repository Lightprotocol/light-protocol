...
/**
 * Create a compression struct for decompressing to CToken ATA
 * @param amount - Amount to decompress
 * @param mintIndex - Index of mint in packed accounts
 * @param recipientIndex - Index of recipient CToken account in packed accounts
 * @param tokenProgramIndex - Index of CToken program in packed accounts (for CPI)
 */
