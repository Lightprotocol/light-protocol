 ...
 * light-token account.
 *
 * @param input             Wrap instruction input.
 * @param input.source      Source SPL/T22 token account.
 * @param input.destination Destination light-token account.
 * @param input.owner       Owner of the source account (signer).
 * @param input.mint        Mint address.
 * @param input.amount      Amount to wrap.
 * @param input.splInterface SPL interface info for the compression.
