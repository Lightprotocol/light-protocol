...
describe.sequential("test-rpc with LiteSVM", () => {
  ...
  it("getCompressedAccountProof", async () => {
    ...
    console.log("Proof result - leafIndex:", compressedAccountProof.leafIndex);
    console.log("Proof result - hash:", compressedAccountProof.hash.toString());
