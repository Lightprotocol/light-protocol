...
use crate::instructions_poseidon::PoseidonCircomRounds3;
...
pub fn hash_64_to_vec(input_bytes: Vec<u8>) -> [u8; 32] {
    ...
    //println!("Bytes_hash_to vec: {:?}", input_bytes);
...
mod tests {
	...
	use ark_ff::{BigInteger256, Field,PrimeField, BigInteger};

	use crate::state_merkle_tree::{HashBytes, MerkleTree as MerkleTreeOnchain};
	use crate::arkworks_merkle_tree_poseidon_test::{hash_64_to_vec, MerkleTree};
	use ark_ed_on_bn254::Fq;
	use arkworks_gadgets::poseidon::{PoseidonParameters, PoseidonError, Rounds,circom::CircomCRH, sbox::PoseidonSbox};
	use ark_crypto_primitives::{crh::{TwoToOneCRH, CRH}, Error};
	use arkworks_gadgets::utils::{get_mds_poseidon_circom_bn254_x5_3, get_rounds_poseidon_circom_bn254_x5_3};
	use ark_std::{One};
	...
	pub struct merkle_tree {
	    ...
	    //pub pedersen_params: crh::pedersen::Parameters<Edwards>,
	    //pub leaf_pedersen_params: crh::pedersen::Parameters<Edwards>,
	}
	...
	fn print_instruction_order_helper(tree_height: usize) {
    ...
    fn merkle_tree_offchain_vs_onchain_implementation_insert() {
        ...
        for i in 0..1 {
			...
			for i in init_bytes11::INSERT_INSTRUCTION_ORDER_11 {
				processor_merkle_tree::_process_instruction_merkle_tree(i, &mut hash_tmp_account, &mut smt, new_leaf_hash_bytes.clone());
			}
