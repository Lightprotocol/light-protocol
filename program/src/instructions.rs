...
pub fn custom_square_in_place_instruction_else_1(
    ...
    let v3 = <ark_ff::fields::models::fp12_2over3over2::Fp12ParamsWrapper<
        ark_bls12_381::Fq12Parameters,
    > as QuadExtParameters>::sub_and_mul_base_field_by_nonresidue(&f.c0, &f.c1); // cost 1108
...
pub fn custom_square_in_place_instruction_else_3(
    ...
    let c0 = <ark_ff::fields::models::fp12_2over3over2::Fp12ParamsWrapper<
        ark_bls12_381::Fq12Parameters,
    > as QuadExtParameters>::add_and_mul_base_field_by_nonresidue_plus_one(&v0, &v2); // cost 1550
...
// 9 (M4.a):
pub fn custom_ell_instruction_M_4(f_range: &mut Vec<u8>) {
    let mut f = parse_f_from_bytes(f_range); // 58284
...
// 10
pub fn custom_ell_instruction_M_5(f_range: &mut Vec<u8>, aa_range: &Vec<u8>, bb_range: &Vec<u8>) {
    let mut f = parse_f_from_bytes(f_range); // 58284
...
pub fn instruction_onchain_coeffs_2(
    ...
    let mut coeff: (
        QuadExtField<ark_ff::Fp2ParamsWrapper<ark_bls12_381::Fq2Parameters>>,
        QuadExtField<ark_ff::Fp2ParamsWrapper<ark_bls12_381::Fq2Parameters>>,
        QuadExtField<ark_ff::Fp2ParamsWrapper<ark_bls12_381::Fq2Parameters>>,
    ) = (
        QuadExtField::<ark_ff::Fp2ParamsWrapper<ark_bls12_381::Fq2Parameters>>::new(
            ark_ff::Fp384::<ark_bls12_381::FqParameters>::new(BigInteger384::new([
                0, 0, 0, 0, 0, 0,
            ])),
            ark_ff::Fp384::<ark_bls12_381::FqParameters>::new(BigInteger384::new([
                0, 0, 0, 0, 0, 0,
