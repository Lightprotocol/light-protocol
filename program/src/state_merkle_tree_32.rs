...
impl Pack for MerkleTree {
    ...
    fn unpack_from_slice(input:  &[u8]) ->  Result<Self, ProgramError>{
        ...
        //height 8
    ) = array_refs![input, 1, 8, 1024, 8, 8, 8, 16000, 8, 32, 8];
        ...
        let mut tmp_subtree_vec = vec![vec![0u8;32]; 32];
    ...
    fn pack_into_slice(&self, dst: &mut [u8]) {
        ...
        //if self.inserted_leaf {
            ...
            //height 8
        ) = mut_array_refs![dst, 1, 8, 1024, 8, 8, 8, 16000, 8, 32, 8];
