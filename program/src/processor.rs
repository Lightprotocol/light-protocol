...
pub fn _process_instruction(
    ...
    // #0 put outside
    // if id == 0 {
    //     // init_f_instruction(&mut account_main.f_range, f);
    //     // account_main.changed_variables[F_RANGE_INDEX] = true;

    // }
    // else if id == 1 { println!("id: 1, no instruction specified"); // if
    // } else if id == 2 { println!("id: 2, no instruction specified"); // if
    // } else ...>connect
    if id == 3 {
        custom_square_in_place_instruction_else_1(&account_main.f_range, &mut account_main.cubic_v0_range, &mut account_main.cubic_v3_range); //  &mut account_main.cubic_v2_range,
        ...
        custom_square_in_place_instruction_else_2(&mut account_main.cubic_v0_range, &account_main.cubic_v3_range);
        account_main.changed_variables[CUBIC_V0_RANGE_INDEX] = true;
    } else if id == 5 {
        custom_square_in_place_instruction_else_3(&account_main.cubic_v0_range, &account_main.cubic_v2_range, &mut account_main.f_range);
    ...
    } else if id == 6 { println!("id: 6, no instruction specified"); // @20
    } else if id == 7 {
        custom_ell_instruction_M_2(&account_main.f_range, &mut account_main.coeff_1_range, &mut account_main.coeff_0_range, &mut account_main.aa_range); // F_c0 (0)
        ...
        custom_ell_instruction_M_3(&mut account_main.bb_range, &account_main.f_range, &account_main.coeff_2_range); // F_C1 (1)
        ...
        custom_ell_instruction_M_5(&mut account_main.f_range, &account_main.aa_range, &account_main.bb_range);
        account_main.changed_variables[F_RANGE_INDEX] = true;
    ...
    // } else if id == 15 { println!("id: 15, no instruction specified"); // ::D
        ...
        custom_square_in_place_instruction_else_1_b(&account_main.f_range, &mut account_main.cubic_v2_range); //  else 1.b (split 1)
        account_main.changed_variables[CUBIC_V2_RANGE_INDEX] = true;
    } else if id == 18 {
        custom_ell_instruction_M_4_b(&mut account_main.f_range, &account_main.coeff_2_range, &account_main.coeff_1_range, &account_main.coeff_0_range);
        account_main.changed_variables[F_RANGE_INDEX] = true;
    } else if id == 19 { println!("id: 19, no instruction specified");
    // for coeff call order refer to the coeff lists l:1214 in constraints.rs

    } else if id == 20 {
        custom_ell_instruction_M_1(&mut account_main.coeff_2_range, &mut account_main.coeff_1_range, &mut account_main.coeff_0_range, &account_main.p_1_y_range, &account_main.p_1_x_range, &coeff_2, &coeff_1, &coeff_0 );
        ...
        custom_ell_instruction_M_1(&mut account_main.coeff_2_range, &mut account_main.coeff_1_range, &mut account_main.coeff_0_range, &account_main.p_2_y_range, &account_main.p_2_x_range, &coeff_2, &coeff_1, &coeff_0 );
        ...
        custom_ell_instruction_M_1(&mut account_main.coeff_2_range, &mut account_main.coeff_1_range, &mut account_main.coeff_0_range, &account_main.p_3_y_range, &account_main.p_3_x_range, &coeff_2, &coeff_1, &coeff_0 );
    ...
    // INSTRUCTION ONCHAIN COEFFS_2 AND 3
        ...
        instruction_onchain_coeffs_2(&mut account_main.current_coeff_2_range, &mut account_main.coeff_2_range, &mut account_main.coeff_1_range, &mut account_main.coeff_0_range);
        ...
        instruction_onchain_coeffs_3(&mut account_main.current_coeff_3_range, &mut account_main.coeff_2_range, &mut account_main.coeff_1_range, &mut account_main.coeff_0_range);
    ...
    // 231-238 (6+1)
        ...
        msg!("account_main.coeff_1_range: {:?}", account_main.coeff_1_range);
        msg!("account_main.coeff_2_range: {:?}", account_main.coeff_2_range);
        ...
        addition_step_custom_0::<ark_bls12_381::Parameters>(&mut account_main.r, &mut account_main.h, &mut account_main.g, &mut account_main.e, &mut account_main.lambda, &mut account_main.theta, &account_main.proof_b);
        for i in 16..22 {
            account_main.changed_variables[i]= true;
        }
    } else if id == 235 {
        ...
        addition_step_custom_1::<ark_bls12_381::Parameters>(&mut account_main.r, &mut account_main.h, &mut account_main.g, &mut account_main.e, &mut account_main.lambda, &mut account_main.theta);
        account_main.changed_variables[21]= true;

    } else if id == 236 {
        // msg!("instruction: {}", _instruction_data[0]);
        addition_step_custom_2::<ark_bls12_381::Parameters>( &mut account_main.coeff_0_range, &mut account_main.coeff_1_range, &mut account_main.coeff_2_range, &mut account_main.lambda, &mut account_main.theta, &account_main.proof_b);
        account_main.changed_variables[5]= true;
        account_main.changed_variables[6]= true;
        account_main.changed_variables[8]= true;
    } else if id == 237 {
        // inside lib
        init(&mut account_main.r, &mut account_main.proof_b, proof_b_bytes);
        account_main.changed_variables[21]= true;
...
pub fn _process_instruction_bridge_to_final_exp(id: u8, account_main_data:  &mut MillerLoopBytes, account_verify_part_2_data: &mut FinalExpBytes){

    if id == 255 {        // pass final f to account_verif
