...
pub fn _pre_process_instruction_miller_loop(
    ...
    if ix_order_array[account_main_data.current_instruction_index] == 0 {
    ...
    // Passes final f to account_verif2. Skipped for testing purposes.
    else if ix_order_array[account_main_data.current_instruction_index] == 255 {
        ...
        if ix_order_array[account_main_data.current_instruction_index] == 2 {
            proof_b_bytes = _instruction_data[2..194].to_vec();
        }

        _process_instruction(
            ix_order_array[account_main_data.current_instruction_index],
            &mut account_main_data,
