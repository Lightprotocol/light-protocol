        ...
        match account_main_data {
            Ok(account_main_data) => (
                ...
                if account_main_data.signer_pubkey != *signing_account.key {
                    ...
                    if account_main_data.current_instruction_index == 1 || account_main_data.current_instruction_index == 1503 {
...
pub const IX_ORDER: [u8; 1503] = [
    //prepare inputs
    1, 40, 41, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42,
