...
pub fn custom_f_inverse_5(
    ...
    parse_f_to_bytes(<ark_ec::models::bn::Bn::<ark_bn254::Parameters> as ark_ec::PairingEngine>::Fqk::new(c0, c1), _f_f2_range);//30
...
pub fn custom_cubic_inverse_2(
    ...
    ////sol_log_compute_units();
    parse_cubic_to_bytes_sub(ark_ff::fields::models::cubic_extension::CubicExtField::<ark_ff::fields::models::fp6_3over2::Fp6ParamsWrapper<ark_bn254::Fq6Parameters>>::new(c0, c1, c2), _cubic_range_0, solo_cubic_0_range);
...
mod tests {
    ...
    */
    ...
    fn custom_inverse_test_correct() {
        ...
        assert_eq!(quad.inverse().unwrap() , parse_quad_from_bytes(&account_struct.quad_range_3_s), "quad inverse failed");
        ...
        assert_eq!(cubic.inverse().unwrap() , parse_cubic_from_bytes_sub(&account_struct.cubic_range_0_s, solo_cubic_0_range), "cubic inverse failed");
    ...
    fn custom_inverse_test_fails() {
        ...
        //reference_f;
        //println!("{:?}", reference_f);
        assert!(reference_f.inverse().unwrap() != parse_f_from_bytes(&account_struct.f_f2_range_s), "f inverse failed");
    }
    ...
    fn mul_assign_test_correct() {
        ...
        reference_f *= mul_f;
        assert_eq!(reference_f,  parse_f_from_bytes(&account_struct.f1_r_range_s), "f mulassign failed");
    }
    ...
    fn mul_assign_test_fails() {
        ...
        reference_f *= mul_f;
        assert!(reference_f !=  parse_f_from_bytes(&account_struct.f1_r_range_s), "f mulassign failed");
    }
    ...
    fn exp_by_neg_x_test_correct() {
        ...
        assert_eq!(reference_f, parse_f_from_bytes(&account_struct.y1_range_s), "f exp_by_neg_x failed");
        //println!("success");
    }
    ...
    fn exp_by_neg_x_test_fails() {
        ...
        let reference_f = exp_by_neg_x(reference_f);
        assert!(reference_f != parse_f_from_bytes(&account_struct.y1_range_s), "f exp_by_neg_x failed");
        //println!("success");
    }
