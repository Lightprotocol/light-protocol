...
impl Pack for ChecksAndTransferState {
    const LEN: usize = 4332;//3900; // 1020
    ...
    fn unpack_from_slice(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        ) = array_refs![input, 1, 1, 1, 1, 32, 8, 32, 8, 32, 32, 32, 32, 8, 3296, 816];
    ...
    fn pack_into_slice(&self, dst: &mut [u8]) {
        ...
        ) = mut_array_refs![dst, 1, 1, 1, 1, 32, 8, 32, 8, 32, 32, 32, 32, 8, 3296, 816];
...
impl Pack for InstructionIndex {
    ...
    fn unpack_from_slice(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        let (
            ...
            current_instruction_index,
            _unused_remainder2,
        ) = array_refs![input, 1, 1, 2, 32, 176, 8, 3680 + 432];
