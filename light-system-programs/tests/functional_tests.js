...
describe("verifier_program", () => {
  ...
  it.skip("build compressed merkle tree", () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  it("Deposit 10 utxo", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      let balance = yield provider.connection.getBalance(
        light_sdk_1.Transaction.getSignerAuthorityPda(
          merkleTreeProgram.programId,
          light_sdk_1.verifierProgramOneProgramId
        ),
        "confirmed"
      );
      if (balance === 0) {
      ...
      for (var i = 0; i < 1; i++) {
        ...
        yield token.approve(
          ...
          light_sdk_1.AUTHORITY_ONE, //delegate
          light_sdk_1.USER_TOKEN_ACCOUNT, // owner
          depositAmount * 2,
          [light_sdk_1.USER_TOKEN_ACCOUNT]
        );
        const prov = yield light_sdk_1.Provider.native(
          light_sdk_1.ADMIN_AUTH_KEYPAIR
        );
    ...
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        yield token.approve(
          ...
          light_sdk_1.ADMIN_AUTH_KEYPAIR,
          light_sdk_1.userTokenAccount,
          light_sdk_1.AUTHORITY, //delegate
          light_sdk_1.USER_TOKEN_ACCOUNT, // owner
          depositAmount * 2,
          [light_sdk_1.USER_TOKEN_ACCOUNT]
        );
  ...
  it("Withdraw", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      let leavesPdas = yield light_sdk_1.SolMerkleTree.getInsertedLeaves(
        light_sdk_1.MERKLE_TREE_KEY
      );
      let decryptedUtxo1 = yield (0, light_sdk_1.getUnspentUtxo)(
        leavesPdas,
        provider,
        KEYPAIR,
        POSEIDON,
  ...
  it("Withdraw 10 utxos", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      yield prov.provider.connection.confirmTransaction(
        yield prov.provider.connection.requestAirdrop(relayerRecipient, 1000000)
      );
      yield prov.provider.connection.confirmTransaction(
        yield prov.provider.connection.requestAirdrop(recipientFee, 1000000)
      );
      let relayer = new light_sdk_1.Relayer(
        light_sdk_1.ADMIN_AUTH_KEYPAIR.publicKey,
        prov.lookUpTable,
