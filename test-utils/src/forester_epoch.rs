...
use light_registry::{
    ...
    utils::{get_epoch_pda_address, get_forester_epoch_pda_address, get_forester_pda_address},
...
impl Epoch {
    ...
    pub async fn register<R: RpcConnection>(
        ...
        let epoch_pda = rpc
            ...
            .await?
            .unwrap();
        let forester_pda = get_forester_pda_address(&authority.pubkey()).0;
        let forester_epoch_pda_pubkey =
            get_forester_epoch_pda_address(&forester_pda, epoch_registration.epoch).0;
