...
describe("Tests", () => {
  ...
  function hexPoseidonHashString(hasher: any, input: string[]): string {
    return String.prototype.concat("0x", new BN(hasher.poseidonHashString(input)).toString(16));
  }

  it.skip("test poseidon(1,2,3)", async () => {
    const hasher = await WasmFactory.getInstance();

    console.log("poseidon(0) = ", hexPoseidonHashString(hasher, ["0"]));
    console.log("poseidon(1) = ", hexPoseidonHashString(hasher,["1"]));
    console.log("poseidon(2) = ", hexPoseidonHashString(hasher, ["2"]));

    console.log("poseidon(0, 0) = ", hexPoseidonHashString(hasher, ["0", "0"]));
    console.log("poseidon(0, 1) = ", hexPoseidonHashString(hasher, ["0", "1"]));
    console.log("poseidon(1, 1) = ", hexPoseidonHashString(hasher, ["1", "1"]));
    console.log("poseidon(1, 2) = ", hexPoseidonHashString(hasher, ["1", "2"]));

    console.log("poseidon(0, 0, 0) = ", hexPoseidonHashString(hasher, ["0", "0", "0"]));
    console.log("poseidon(1, 1, 1) = ", hexPoseidonHashString(hasher, ["1", "1", "1"]));
    console.log("poseidon(1, 2, 3) = ", hexPoseidonHashString(hasher, ["1", "2", "3"]));
  });
