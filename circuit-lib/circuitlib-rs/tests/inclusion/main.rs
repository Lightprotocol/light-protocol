use circuitlib_rs::{
    groth16_solana_verifier::groth16_solana_verify, helpers::init_logger,
    init_merkle_tree::inclusion_merkle_tree_inputs, merkle_inclusion_proof::merkle_inclusion_proof,
