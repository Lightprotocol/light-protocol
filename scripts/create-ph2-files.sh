...
$SEMAPHORE_MTB_SETUP p1i "$REPO_ROOT/ceremony/17.ptau" "$REPO_ROOT/ceremony/17.ph1"
...
for inclusion_accounts in 1 2 3 4 8; do
    for non_inclusion_accounts in 1 2 4 8; do
...
PH1_FILE="$REPO_ROOT/ceremony/17.ph1"
