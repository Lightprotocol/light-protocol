...
mod light_transaction_tests {
    ...
    fn test_parse_light_transaction_functional() {
        ...
        */
        ...
        component main {public [publicZ, publicTransactionHash, publicProgramId]} =  TestData(22, 4, 4, 6686672797465227418401714772753289406522066866583537086457438811846503839916, 0, 1, 3, 2, 2);";
