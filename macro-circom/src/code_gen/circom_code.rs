...
mod light_transaction_tests {
    ...
    fn test_parse_light_transaction_functional() {
        ...
        */
        ...
        component main {public [publicZ, publicTransactionHash, publicProgramId]} =  TestData(22, 4, 4, 184598798020101492503359154328231866914977581098629757339001774613643340069, 0, 1, 3, 2, 2);";
