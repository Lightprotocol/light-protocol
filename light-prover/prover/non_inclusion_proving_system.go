...
func SetupNonInclusion(treeDepth uint32, numberOfCompressedAccounts uint32, keyFilePath string) (*ProvingSystem, error) {
	...
	return &ProvingSystem{
		InclusionTreeDepth:                     0,
		InclusionNumberOfCompressedAccounts:    0,
