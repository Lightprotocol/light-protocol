        ...
        match action {
            ...
            Transfer2InstructionType::CompressAndClose(compress_and_close_input) => {
                ...
                let expected_tlv = if needs_tlv {
                    Some(vec![
                        light_ctoken_types::state::ExtensionStruct::CompressedOnly(
                            light_ctoken_types::state::CompressedOnlyExtension {
                ...
                let expected_token = light_compressed_token_sdk::compat::TokenData {
                    mint: expected_mint,
