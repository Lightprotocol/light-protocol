use crate::verifying_key_create_vote_utxo::VERIFYINGKEY_CREATE_VOTE_UTXO;
...
// #[inline(never)]
// pub fn verify_program_proof<'a>(
//     inputs: &'a Vec<u8>,
//     checked_public_inputs: &'a Vec<u8>,
// ) -> Result<()> {
//     let verifier_state = ctx.accounts.verifier_state.load()?;
//     let proof_app = Proof {
...
//         &proof_app,
//         &checked_public_inputs.try_into().unwrap(),
