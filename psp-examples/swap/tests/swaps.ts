...
describe("Test swaps", () => {
  ...
  it("Swap Take functional", async () => {
    ...
    const txHashMakeOffer = await compressProgramUtxo({
    ...
    const compressUtxo = buyerUser.getAllUtxos()[0];
    ...
    const changeAmountSol = compressUtxo.amounts[0]
    ...
    const {
      ...
      inputUtxos: [fetchedOfferUtxo, compressUtxo],
      rpc: RPC,
  ...
  it("Swap Counter Offer functional", async () => {
    ...
    let txHashMakeOffer = await compressProgramUtxo({
      account: sellerUser.account,
      appUtxo: offerUtxo,
      provider: sellerUser.provider,
    });
    ...
    let txHashMakeCounterOffer = await compressProgramUtxo({
      account: buyerUser.account,
