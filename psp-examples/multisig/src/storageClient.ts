...
export class StorageUtils {
  ...
  static async encryptTo(
    ...
    let iv = blake2b
      ...
      .digest();
    const aesCiphertext = await Account.encryptAes(aesSecretKey, message, iv);
  ...
  static async decryptMultipleRecipients(
    ...
    for (
      ...
      const decryptedAesKeyCandidate = account.decryptNacl(
    ...
    return await Account.decryptAes(encryptedAesKey, ciphertextAes);
  }
}
