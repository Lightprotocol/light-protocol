...
///
/// Can be specified via CLI `--light-pda-program` (using `program_id:discriminator_base58` format)
...
pub struct CompressibleConfig {
    ...
    /// Can be specified in config file or via CLI `--light-pda-program` flags.
