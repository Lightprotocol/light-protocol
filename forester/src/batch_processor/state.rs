...
use crate::indexer_type::{update_test_indexer_after_append, update_test_indexer_after_nullification, IndexerType};
...
pub(crate) async fn perform_append<R: RpcConnection, I: Indexer<R> + IndexerType<R>>(
   ...
   update_test_indexer_after_append(
       ...
       .await.expect("Failed to update test indexer after append");
...
pub(crate) async fn perform_nullify<R: RpcConnection, I: Indexer<R> + IndexerType<R>>(
    ...
    update_test_indexer_after_nullification(
        ...
        .await.expect("Failed to update test indexer after nullification");
