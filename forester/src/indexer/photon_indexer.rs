...
pub struct PhotonIndexer<const INDEXED_ARRAY_SIZE: usize, R: RpcConnection> {
    configuration: Configuration,
    rpc: R,
}

impl<const INDEXED_ARRAY_SIZE: usize, R: RpcConnection> PhotonIndexer<INDEXED_ARRAY_SIZE, R> {
...
impl<const INDEXED_ARRAY_SIZE: usize, R: RpcConnection> Debug
    for PhotonIndexer<INDEXED_ARRAY_SIZE, R>
{
...
impl<const INDEXED_ARRAY_SIZE: usize, R: RpcConnection> Indexer<INDEXED_ARRAY_SIZE, R>
    for PhotonIndexer<INDEXED_ARRAY_SIZE, R>
{
