...
class MerkleTree {
  ...
  constructor(
    levels,
    elements = [],
    { hashFunction, zeroElement = DEFAULT_ZERO } = {},
  ) {
    this.levels = levels;
    ...
    //console.log("first test ", this._hash('8995896153219992062710898675021891003404871425075198597897889079729967997688', '8995896153219992062710898675021891003404871425075198597897889079729967997688').toString())
    this._zeros = [];
    this._layers = [];
