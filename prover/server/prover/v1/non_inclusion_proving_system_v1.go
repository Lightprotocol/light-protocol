...
func V1ProveNonInclusion(ps *common.MerkleProofSystem, params *V1NonInclusionParameters) (*common.Proof, error) {
...
func V1VerifyNonInclusion(ps *common.MerkleProofSystem, root []big.Int, leaves []big.Int, proof *common.Proof) error {
