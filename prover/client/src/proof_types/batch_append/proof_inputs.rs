...
/// V2: Batch append without changelogs (for use with staging trees).
///
/// This version assumes proofs are already adjusted incrementally via a staging tree,
/// so no changelog adjustments are needed.
#[allow(clippy::too_many_arguments)]
pub fn get_batch_append_inputs_v2<const HEIGHT: usize>(
    ...
    // Convert merkle proofs to BigInt format
