...
export const LIGHT_HASHER_VERSION = "1.0.0";
export const LIGHT_MACROS_VERSION = "1.0.0";
export const LIGHT_SDK_VERSION = "0.9.0";
export const LIGHT_SDK_MACROS_VERSION = "0.2.0";
export const LIGHT_UTILS_VERSION = "1.0.0";
export const LIGHT_VERIFIER_VERSION = "1.0.0";
export const SOLANA_SDK_VERSION = "1.18.22";
export const LIGHT_CLIENT_VERSION = "0.8.0";
