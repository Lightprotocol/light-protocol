...
keys="light_merkle_tree_program light_psp2in2out light_psp10in2out light_psp4in4out_app_storage light_psp2in2out_storage light_user_registry psp_compressed_token account_compression"
