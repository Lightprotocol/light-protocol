 ...
 * Run this on public networks if you're setting your own rpc for the first time.
 * Ensure that you're setting the LOOK_UP_TABLE env var to the value printed by this script.
 * FYI: Running rpc tests will override your env var with a fixed base58 value.
 */
(async () => {
