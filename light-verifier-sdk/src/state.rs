    ...
    From<Transaction<'_, '_, '_, NR_LEAVES, NR_NULLIFIERS, T>> for VerifierState10Ins<T>
{
    fn from(
        ...
        VerifierState10Ins {
            ...
            leaves,
            public_amount_spl: *light_tx.input.public_amount_spl,
            public_amount_sol: *light_tx.input.public_amount_sol,
            ...
            proof_a: *light_tx.input.proof_a,
            proof_b: *light_tx.input.proof_b,
            proof_c: *light_tx.input.proof_c,
