...
pub fn rollover_batch_state_tree(
    ...
    let params = InitStateTreeAccountsInstructionData {
        ...
        additional_bytes,
        output_queue_batch_size: old_output_queue.get_metadata().batch_metadata.batch_size,
        output_queue_zkp_batch_size: old_output_queue
            .get_metadata()
            .batch_metadata
            .zkp_batch_size,
...
pub fn assert_state_mt_roll_over(params: StateMtRollOverAssertParams) {
    ...
    let zero_copy_queue =
        BatchedQueueAccount::from_bytes_unchecked_mut(&mut queue_account_data).unwrap();
    assert_eq!(
