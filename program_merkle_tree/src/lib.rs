...
pub fn process_instruction(
    ...
    else if instruction_data.len() >= 9 && instruction_data[8] == 100 {
        ...
        match tmp_storage_pda_data {
            Err(ProgramError::InvalidAccountData) => {
                ...
                create_and_try_initialize_tmp_storage_pda(
                    ...
                    0_u64,                                   // lamports
                    true,                                    // rent_exempt
                    &instruction_data[9..], // Data starts after instruction identifier.
                )
            }
...
pub const IX_ORDER: [u8; 76] = [
    ...
    41, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42,
