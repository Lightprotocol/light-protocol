...
pub fn poseidon_0(account_struct_data: &mut MerkleTreeTmpPda) -> Result<(),ProgramError> {
...
pub fn poseidon_1(account_struct_data: &mut MerkleTreeTmpPda) -> Result<(),ProgramError> {
...
pub fn poseidon_2(account_struct_data: &mut MerkleTreeTmpPda) -> Result<(),ProgramError> {
    let mut current_round_index = account_struct_data.current_round_index;
    let mut current_round = account_struct_data.current_round;
