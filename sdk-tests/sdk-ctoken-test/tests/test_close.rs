// Tests for CloseCTokenAccountInfos invoke() and invoke_signed()
...
/// Test closing a compressible token account using CloseCTokenAccountInfos::invoke()
#[tokio::test]
...
/// Test closing a PDA-owned compressible token account using CloseCTokenAccountInfos::invoke_signed()
#[tokio::test]
