...
use light_sdk::{
    ...
    compressible::{
        ...
        CompressAs, CompressedInitSpace, CompressibleConfig, CompressionInfo, HasCompressionInfo,
        Pack, Unpack,
    },
...
use light_sdk_types::{cpi_accounts::CpiAccountsConfig, CpiSigner};
...
pub mod csdk_anchor_test {
    ...
    pub fn create_placeholder_record<'info>(
        ...
        *placeholder_record.compression_info_mut_opt() =
        ...
        msg!("compressing account on init (keeps PDA open for demo)");
        ...
        msg!("...compressed account on init");
