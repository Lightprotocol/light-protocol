...
/// Test creating a single compressible PDA using manual implementation.
#[tokio::test]
async fn test_create_pda() {
    ...
    let accounts = manual_test::accounts::CreatePda {
    ...
    let instruction_data = manual_test::instruction::CreatePda {
