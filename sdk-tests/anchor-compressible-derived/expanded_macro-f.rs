...
use anchor_lang::{
    prelude::*,
    solana_program::{
        instruction::AccountMeta, program::{invoke, invoke_signed},
        pubkey::Pubkey,
    },
};
...
use light_sdk::{
    ...
    compressible::{
        ...
        CompressibleConfig, CompressionInfo, HasCompressionInfo, Unpack,
    },
    cpi::CpiInputs, derive_light_cpi_signer,
    instruction::{
...
pub mod instructions {
    pub mod create_record {
        ...
        impl<'info> anchor_lang::Accounts<'info, CreateRecordBumps>
        for CreateRecord<'info>
        where
            'info: 'info,
        {
            #[inline(never)]
                                        ...
                                        anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                                ...
                                                error_origin: Some(
                                                    anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                                        filename: "sdk-tests/anchor-compressible-derived/src/instructions/create_record.rs",
                                                        line: 6u32,
                                                    }),
                                                ),
                                    ...
                                    <[_]>::into_vec(
                                        ::alloc::boxed::box_new([
                                            ...
                                            anchor_lang::idl::types::IdlField {
                                                ...
                                                docs: <[_]>::into_vec(
                                                    ::alloc::boxed::box_new([
                                                        "UNCHECKED: checked via config.".into(),
                                                    ]),
                                                ),
                                                ty: anchor_lang::idl::types::IdlType::Pubkey,
                                            },
                                            anchor_lang::idl::types::IdlField {
                                                ...
                                                docs: <[_]>::into_vec(
                                                    ::alloc::boxed::box_new([
                                                        ...
                                                        "UNCHECKED: checked via load_checked.".into(),
                                                    ]),
                                                ),
                                                ty: anchor_lang::idl::types::IdlType::Pubkey,
                                            },
                ...
                fn get_full_path() -> String {
                    ::alloc::__export::must_use({
                        let res = ::alloc::fmt::format(
                            format_args!(
                                "{0}::{1}",
                                "anchor_compressible_derived::instructions::create_record::__client_accounts_create_record",
                                "CreateRecord",
                            ),
                        );
                        res
        ...
        pub(crate) mod __cpi_client_accounts_create_record {
            ...
            impl<'info> anchor_lang::ToAccountInfos<'info> for CreateRecord<'info> {
                fn to_account_infos(
                    ...
                    account_infos
                        .extend(
                            anchor_lang::ToAccountInfos::to_account_infos(&self.user),
                        );
                    account_infos
                        .extend(
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::state",
                        "UserRecord",
                    ),
                );
                res
            ...
            if UserRecord::DISCRIMINATOR != given_disc {
                return Err(
                    anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                            ...
                            error_origin: Some(
                                anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                    filename: "sdk-tests/anchor-compressible-derived/src/state.rs",
                                    line: 9u32,
                                }),
                            ),
                            compared_values: None,
    ...
    impl borsh::ser::BorshSerialize for CTokenAccountVariant {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            let variant_idx: u8 = match self {
                ...
                CTokenAccountVariant::AssociatedTokenAccount => 1u8,
            };
    ...
    impl borsh::de::EnumExt for CTokenAccountVariant {
        fn deserialize_variant<R: borsh::maybestd::io::Read>(
            ...
            let mut return_value = match variant_idx {
                ...
                1u8 => CTokenAccountVariant::AssociatedTokenAccount,
                _ => {
                    return Err(
    ...
    impl ::core::fmt::Debug for CTokenAccountVariant {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            ::core::fmt::Formatter::write_str(
                f,
                match self {
                    CTokenAccountVariant::CTokenSigner => "CTokenSigner",
                    CTokenAccountVariant::AssociatedTokenAccount => {
...
pub fn get_user_record_seeds(user: &Pubkey) -> (Vec<Vec<u8>>, Pubkey) {
    ...
    let bump_slice = <[_]>::into_vec(::alloc::boxed::box_new([bump]));
    let seeds_vec = <[_]>::into_vec(
        ::alloc::boxed::box_new([seeds[0].to_vec(), seeds[1].to_vec(), bump_slice]),
    );
    (seeds_vec, pda)
}
...
pub enum CompressedAccountVariant {
    ...
    CompressibleTokenData(
        light_sdk::token::CompressibleTokenDataWithVariant<CTokenAccountVariant>,
    ),
}
#[automatically_derived]
impl ::core::clone::Clone for CompressedAccountVariant {
    ...
    fn clone(&self) -> CompressedAccountVariant {
        match self {
            ...
            CompressedAccountVariant::CompressibleTokenAccountPacked(__self_0) => {
                CompressedAccountVariant::CompressibleTokenAccountPacked(
                    ::core::clone::Clone::clone(__self_0),
                )
            }
            CompressedAccountVariant::CompressibleTokenData(__self_0) => {
...
where
    ...
    light_sdk::token::CompressibleTokenDataWithVariant<
        CTokenAccountVariant,
    >: borsh::ser::BorshSerialize,
{
    fn serialize<W: borsh::maybestd::io::Write>(
        ...
        let variant_idx: u8 = match self {
            ...
            CompressedAccountVariant::CompressibleTokenAccountPacked(..) => 6u8,
            CompressedAccountVariant::CompressibleTokenData(..) => 7u8,
        };
        writer.write_all(&variant_idx.to_le_bytes())?;
        match self {
            ...
            CompressedAccountVariant::CompressibleTokenAccountPacked(id0) => {
                borsh::BorshSerialize::serialize(id0, writer)?;
            }
            CompressedAccountVariant::CompressibleTokenData(id0) => {
                borsh::BorshSerialize::serialize(id0, writer)?;
            }
        }
        Ok(())
...
impl anchor_lang::idl::build::IdlBuild for CompressedAccountVariant {
            ...
            ty: anchor_lang::idl::types::IdlTypeDefTy::Enum {
                variants: <[_]>::into_vec(
                    ::alloc::boxed::box_new([
                        ...
                        anchor_lang::idl::types::IdlEnumVariant {
                            name: "CompressibleTokenAccountPacked".into(),
                            fields: Some(
                                anchor_lang::idl::types::IdlDefinedFields::Tuple(
                                    <[_]>::into_vec(
                                        ::alloc::boxed::box_new([
                                            anchor_lang::idl::types::IdlType::Defined {
                                                name: <light_sdk::token::PackedCompressibleTokenDataWithVariant<
                                                    CTokenAccountVariant,
                                                >>::get_full_path(),
                                                generics: <[_]>::into_vec(
                                                    ::alloc::boxed::box_new([
                        ...
                        anchor_lang::idl::types::IdlEnumVariant {
                            name: "CompressibleTokenData".into(),
                            fields: Some(
                                anchor_lang::idl::types::IdlDefinedFields::Tuple(
                                    <[_]>::into_vec(
                                        ::alloc::boxed::box_new([
                                            anchor_lang::idl::types::IdlType::Defined {
                                                name: <light_sdk::token::CompressibleTokenDataWithVariant<
                                                    CTokenAccountVariant,
                                                >>::get_full_path(),
                                                generics: <[_]>::into_vec(
                                                    ::alloc::boxed::box_new([
    ...
    fn insert_types(
        ...
        if let Some(ty) = <light_sdk::token::PackedCompressibleTokenDataWithVariant<
            CTokenAccountVariant,
        >>::create_type() {
            types
                .insert(
        ...
        if let Some(ty) = <light_sdk::token::CompressibleTokenDataWithVariant<
            CTokenAccountVariant,
        >>::create_type() {
            types
                .insert(
...
impl light_sdk::compressible::Unpack for CompressedAccountVariant {
    ...
    fn unpack(
        ...
        match self {
            ...
            Self::CompressibleTokenAccountPacked(_data) => Ok(self.clone()),
            Self::CompressibleTokenData(_data) => {
                ::core::panicking::panic("internal error: entered unreachable code")
            }
        }
    }
...
use self::anchor_compressible_derived::*;
/// # Safety
#[no_mangle]
...
pub mod program {
    ...
    pub struct AnchorCompressibleDerived;
    #[automatically_derived]
    impl ::core::clone::Clone for AnchorCompressibleDerived {
        #[inline]
        fn clone(&self) -> AnchorCompressibleDerived {
            AnchorCompressibleDerived
        }
    }
    impl anchor_lang::Id for AnchorCompressibleDerived {
        fn id() -> Pubkey {
            ID
        }
    }
...
fn dispatch<'info>(
    ...
    if data.starts_with(instruction::CreateGameSession::DISCRIMINATOR) {
        return __private::__global::create_game_session(
            program_id,
            accounts,
            &data[instruction::CreateGameSession::DISCRIMINATOR.len()..],
        );
    }
    ...
    if data.starts_with(instruction::CreatePlaceholderRecord::DISCRIMINATOR) {
        return __private::__global::create_placeholder_record(
            program_id,
            accounts,
            &data[instruction::CreatePlaceholderRecord::DISCRIMINATOR.len()..],
        );
    }
    ...
    if data.starts_with(instruction::UpdateGameSession::DISCRIMINATOR) {
        return __private::__global::update_game_session(
            program_id,
            accounts,
            &data[instruction::UpdateGameSession::DISCRIMINATOR.len()..],
        );
    }
...
mod __private {
            ...
            fn get_full_path() -> String {
                ::alloc::__export::must_use({
                    let res = ::alloc::fmt::format(
                        format_args!(
                            "{0}::{1}",
                            "anchor_compressible_derived::__private::__idl",
                            "IdlAccount",
                        ),
                    );
                    res
                ...
                if IdlAccount::DISCRIMINATOR != given_disc {
                    return Err(
                        anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                ...
                                error_origin: Some(
                                    anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                        filename: "sdk-tests/anchor-compressible-derived/src/lib.rs",
                                        line: 87u32,
                                    }),
                                ),
                                compared_values: None,
                ...
                fn get_full_path() -> String {
                    ::alloc::__export::must_use({
                        let res = ::alloc::fmt::format(
                            format_args!(
                                "{0}::{1}",
                                "anchor_compressible_derived::__private::__idl::__client_accounts_idl_create_accounts",
                                "IdlCreateAccounts",
                            ),
                        );
                        res
                ...
                fn get_full_path() -> String {
                    ::alloc::__export::must_use({
                        let res = ::alloc::fmt::format(
                            format_args!(
                                "{0}::{1}",
                                "anchor_compressible_derived::__private::__idl::__client_accounts_idl_accounts",
                                "IdlAccounts",
                            ),
                        );
                        res
                ...
                fn get_full_path() -> String {
                    ::alloc::__export::must_use({
                        let res = ::alloc::fmt::format(
                            format_args!(
                                "{0}::{1}",
                                "anchor_compressible_derived::__private::__idl::__client_accounts_idl_resize_account",
                                "IdlResizeAccount",
                            ),
                        );
                        res
                ...
                fn get_full_path() -> String {
                    ::alloc::__export::must_use({
                        let res = ::alloc::fmt::format(
                            format_args!(
                                "{0}::{1}",
                                "anchor_compressible_derived::__private::__idl::__client_accounts_idl_create_buffer",
                                "IdlCreateBuffer",
                            ),
                        );
                        res
                ...
                fn get_full_path() -> String {
                    ::alloc::__export::must_use({
                        let res = ::alloc::fmt::format(
                            format_args!(
                                "{0}::{1}",
                                "anchor_compressible_derived::__private::__idl::__client_accounts_idl_set_buffer",
                                "IdlSetBuffer",
                            ),
                        );
                        res
                ...
                fn get_full_path() -> String {
                    ::alloc::__export::must_use({
                        let res = ::alloc::fmt::format(
                            format_args!(
                                "{0}::{1}",
                                "anchor_compressible_derived::__private::__idl::__client_accounts_idl_close_account",
                                "IdlCloseAccount",
                            ),
                        );
                        res
    ...
    pub mod __global {
        ...
        pub fn initialize_compression_config<'info>(
            ...
            let result = anchor_compressible_derived::initialize_compression_config(
        ...
        pub fn update_compression_config<'info>(
            ...
            let result = anchor_compressible_derived::update_compression_config(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        pub fn compress_accounts_idempotent<'info>(
            ...
            let result = anchor_compressible_derived::compress_accounts_idempotent(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        pub fn create_record<'info>(
            ...
            let result = anchor_compressible_derived::create_record(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        pub fn create_game_session<'info>(
            ...
            ::solana_msg::sol_log("Instruction: CreateGameSession");
            let ix = instruction::CreateGameSession::deserialize(&mut &__ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::CreateGameSession {
                session_id,
                game_type,
                proof,
                compressed_address,
            ...
            let mut __bumps = <CreateGameSession as anchor_lang::Bumps>::Bumps::default();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut __remaining_accounts: &[AccountInfo] = __accounts;
            let mut __accounts = CreateGameSession::try_accounts(
                __program_id,
                &mut __remaining_accounts,
                __ix_data,
                &mut __bumps,
            ...
            let result = anchor_compressible_derived::create_game_session(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        pub fn create_user_record_and_game_session<'info>(
            ...
            let result = anchor_compressible_derived::create_user_record_and_game_session(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        pub fn create_placeholder_record<'info>(
            ...
            ::solana_msg::sol_log("Instruction: CreatePlaceholderRecord");
            let ix = instruction::CreatePlaceholderRecord::deserialize(
                    &mut &__ix_data[..],
                )
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::CreatePlaceholderRecord {
                placeholder_id,
                name,
                proof,
                compressed_address,
            ...
            let mut __bumps = <CreatePlaceholderRecord as anchor_lang::Bumps>::Bumps::default();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut __remaining_accounts: &[AccountInfo] = __accounts;
            let mut __accounts = CreatePlaceholderRecord::try_accounts(
                __program_id,
                &mut __remaining_accounts,
                __ix_data,
                &mut __bumps,
            ...
            let result = anchor_compressible_derived::create_placeholder_record(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        pub fn update_record<'info>(
            ...
            let result = anchor_compressible_derived::update_record(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        #[inline(never)]
        pub fn update_game_session<'info>(
            __program_id: &Pubkey,
            __accounts: &'info [AccountInfo<'info>],
            __ix_data: &[u8],
        ) -> anchor_lang::Result<()> {
            ::solana_msg::sol_log("Instruction: UpdateGameSession");
            let ix = instruction::UpdateGameSession::deserialize(&mut &__ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::UpdateGameSession { _session_id, new_score } = ix;
            let mut __bumps = <UpdateGameSession as anchor_lang::Bumps>::Bumps::default();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut __remaining_accounts: &[AccountInfo] = __accounts;
            let mut __accounts = UpdateGameSession::try_accounts(
                __program_id,
                &mut __remaining_accounts,
                __ix_data,
                &mut __bumps,
            ...
            let result = anchor_compressible_derived::update_game_session(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
        ...
        pub fn decompress_accounts_idempotent<'info>(
            ...
            let result = anchor_compressible_derived::decompress_accounts_idempotent(
                anchor_lang::context::Context::new(
                    __program_id,
                    &mut __accounts,
                    __remaining_accounts,
...
pub mod anchor_compressible_derived {
    ...
    pub fn compress_accounts_idempotent<'info>(
        ...
        let compression_config = CompressibleConfig::load_checked(
            &ctx.accounts.config,
            &crate::ID,
        )?;
        ...
        for (i, account_info) in solana_accounts.iter().enumerate() {
            if account_info.data_is_empty() {
                ::solana_msg::sol_log(
                    "No data. Account already compressed or uninitialized. Skipping.",
                );
                continue;
            }
            if account_info.owner == &COMPRESSED_TOKEN_PROGRAM_ID.into() {
                if let Ok(token_account) = InterfaceAccount::<
                    TokenAccount,
                >::try_from(account_info) {
                    let account_signer_seeds = signer_seeds[i].clone();
                    token_accounts_to_compress
                        .push(light_compressed_token_sdk::TokenAccountToCompress {
                            token_account,
                ...
                match discriminator {
                    d if d == UserRecord::discriminator() => {
                        let mut anchor_account = Account::<
                            UserRecord,
                        >::try_from(account_info)?;
    ...
    pub fn create_user_record_and_game_session<'info>(
        ...
        let user_compressed_infos = prepare_accounts_for_compression_on_init::<
            UserRecord,
        >(
            &[user_record],
        ...
        let game_compressed_infos = prepare_accounts_for_compression_on_init::<
            GameSession,
        >(
            &[game_session],
        ...
        let (_, token_account_address) = get_ctoken_signer_seeds(
    ...
    pub fn create_placeholder_record<'info>(
        ...
        *placeholder_record.compression_info_mut_opt() = Some(
            super::CompressionInfo::new_decompressed()?,
        );
        placeholder_record.compression_info_mut().bump_last_written_slot()?;
        if ctx.accounts.rent_recipient.key() != config.rent_recipient {
            return Err(
                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                    error_name: ErrorCode::InvalidRentRecipient.name(),
    ...
    pub fn update_record(
        ...
        user_record.compression_info_mut().bump_last_written_slot()?;
        Ok(())
    }
    pub fn update_game_session(
        ...
        game_session.compression_info_mut().bump_last_written_slot()?;
        Ok(())
    }
        ...
        'info: 'info,
    {
        ...
        fn try_accounts(
            ...
            let config: AccountInfo = anchor_lang::Accounts::try_accounts(
                ...
                .map_err(|e| e.with_account_name("config"))?;
            let compressed_token_program: Option<UncheckedAccount> = anchor_lang::Accounts::try_accounts(
                    __program_id,
                    __accounts,
                    __ix_data,
                    __bumps,
            ...
            let compressed_token_cpi_authority: Option<UncheckedAccount> = anchor_lang::Accounts::try_accounts(
                    __program_id,
                    __accounts,
                    __ix_data,
                    __bumps,
    ...
    impl<'info> anchor_lang::ToAccountMetas for DecompressAccountsIdempotent<'info> {
        fn to_account_metas(
            ...
            account_metas.extend(self.config.to_account_metas(None));
            if let Some(compressed_token_program) = &self.compressed_token_program {
                account_metas.extend(compressed_token_program.to_account_metas(None));
            } else {
                account_metas.push(AccountMeta::new_readonly(crate::ID, false));
            }
            if let Some(compressed_token_cpi_authority) = &self
                .compressed_token_cpi_authority
            {
                account_metas
                    .extend(compressed_token_cpi_authority.to_account_metas(None));
            } else {
                account_metas.push(AccountMeta::new_readonly(crate::ID, false));
            }
            account_metas
    ...
    pub(crate) mod __client_accounts_decompress_accounts_idempotent {
        ...
        pub struct DecompressAccountsIdempotent {
            ...
            pub config: Pubkey,
            ///Compressed token program
            pub compressed_token_program: Option<Pubkey>,
            ///CPI authority PDA of the compressed token program
            pub compressed_token_cpi_authority: Option<Pubkey>,
        }
                                ...
                                <[_]>::into_vec(
                                    ::alloc::boxed::box_new([
                                        ...
                                        anchor_lang::idl::types::IdlField {
                                            ...
                                            docs: <[_]>::into_vec(
                                                ::alloc::boxed::box_new([
                                                    "UNCHECKED: Anyone can pay to init.".into(),
                                                ]),
                                            ),
                                            ty: anchor_lang::idl::types::IdlType::Pubkey,
                                        },
                                        ...
                                        anchor_lang::idl::types::IdlField {
                                            ...
                                            docs: <[_]>::into_vec(
                                                ::alloc::boxed::box_new([
                                                    "CPI authority PDA of the compressed token program".into(),
                                                ]),
                                            ),
                                            ty: anchor_lang::idl::types::IdlType::Option(
                                                Box::new(anchor_lang::idl::types::IdlType::Pubkey),
            ...
            fn get_full_path() -> String {
                ::alloc::__export::must_use({
                    let res = ::alloc::fmt::format(
                        format_args!(
                            "{0}::{1}",
                            "anchor_compressible_derived::anchor_compressible_derived::__client_accounts_decompress_accounts_idempotent",
    ...
    pub(crate) mod __cpi_client_accounts_decompress_accounts_idempotent {
        ...
        pub struct DecompressAccountsIdempotent<'info> {
            ...
            ///Compressed token program
            pub compressed_token_program: Option<
                anchor_lang::solana_program::account_info::AccountInfo<'info>,
            >,
            ///CPI authority PDA of the compressed token program
            pub compressed_token_cpi_authority: Option<
                anchor_lang::solana_program::account_info::AccountInfo<'info>,
            >,
        }
        #[automatically_derived]
            ...
            fn to_account_metas(
                ...
                if let Some(compressed_token_program) = &self.compressed_token_program {
                    account_metas
                        .push(
                            anchor_lang::solana_program::instruction::AccountMeta::new_readonly(
                                anchor_lang::Key::key(compressed_token_program),
                                false,
                            ),
                        );
                } else {
                    ...
                    .compressed_token_cpi_authority
                {
                    account_metas
                        .push(
                            anchor_lang::solana_program::instruction::AccountMeta::new_readonly(
                                anchor_lang::Key::key(compressed_token_cpi_authority),
                                false,
                            ),
                        );
                } else {
    ...
    pub fn decompress_accounts_idempotent<'info>(
        ...
        for (i, compressed_data) in compressed_accounts.clone().into_iter().enumerate() {
            ...
            match unpacked_data {
                CompressedAccountVariant::UserRecord(data) => {
                    ...
                    let compressed_infos = light_sdk::compressible::prepare_account_for_decompression_idempotent::<
                        UserRecord,
                    >(
                        &crate::ID,
                        data,
                ...
                CompressedAccountVariant::PlaceholderRecord(data) => {
                    let (seeds_vec, _) = get_placeholder_record_seeds(
                        data.placeholder_id,
                    );
                    let compressed_infos = light_sdk::compressible::prepare_account_for_decompression_idempotent::<
                        PlaceholderRecord,
        ...
        if !has_pdas && !has_tokens {
            ::solana_msg::sol_log("All accounts already initialized.");
            return Ok(());
        }
...
pub mod instruction {
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::instruction",
    ...
    where
        ...
        Vec<CompressedAccountMetaNoLamportsNoAddress>: borsh::ser::BorshSerialize,
    ...
    impl anchor_lang::idl::build::IdlBuild for CompressAccountsIdempotent {
                            ...
                            <[_]>::into_vec(
                                ::alloc::boxed::box_new([
                                    ...
                                    anchor_lang::idl::types::IdlField {
                                        ...
                                        ty: anchor_lang::idl::types::IdlType::Vec(
                                            Box::new(anchor_lang::idl::types::IdlType::Defined {
                                                name: <CompressedAccountMetaNoLamportsNoAddress>::get_full_path(),
                                                generics: ::alloc::vec::Vec::new(),
                                            }),
                                        ),
                                    },
        ...
        fn insert_types(
            ...
            if let Some(ty) = <CompressedAccountMetaNoLamportsNoAddress>::create_type() {
                types
                    .insert(
                        <CompressedAccountMetaNoLamportsNoAddress>::get_full_path(),
                        ty,
                    );
                <CompressedAccountMetaNoLamportsNoAddress>::insert_types(types);
            }
        }
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
    ...
    where
        ...
        Vec<CompressedAccountMetaNoLamportsNoAddress>: borsh::BorshDeserialize,
    ...
    impl borsh::ser::BorshSerialize for CreateGameSession
    where
        u64: borsh::ser::BorshSerialize,
        String: borsh::ser::BorshSerialize,
        ValidityProof: borsh::ser::BorshSerialize,
    ...
    impl anchor_lang::idl::build::IdlBuild for CreateGameSession {
        fn create_type() -> Option<anchor_lang::idl::types::IdlTypeDef> {
            Some(anchor_lang::idl::types::IdlTypeDef {
                name: Self::get_full_path(),
                docs: <[_]>::into_vec(::alloc::boxed::box_new(["Instruction.".into()])),
    ...
    impl borsh::de::BorshDeserialize for CreateGameSession
    where
        u64: borsh::BorshDeserialize,
        String: borsh::BorshDeserialize,
        ValidityProof: borsh::BorshDeserialize,
    ...
    impl anchor_lang::Discriminator for CreateGameSession {
        const DISCRIMINATOR: &'static [u8] = &[130, 34, 251, 80, 77, 159, 113, 224];
    }
    impl anchor_lang::InstructionData for CreateGameSession {}
    ...
    /// Instruction.
    pub struct CreatePlaceholderRecord {
        pub placeholder_id: u64,
        pub name: String,
        pub proof: ValidityProof,
        pub compressed_address: [u8; 32],
    ...
    impl borsh::ser::BorshSerialize for CreatePlaceholderRecord
    where
        u64: borsh::ser::BorshSerialize,
        String: borsh::ser::BorshSerialize,
        ValidityProof: borsh::ser::BorshSerialize,
    ...
    impl anchor_lang::idl::build::IdlBuild for CreatePlaceholderRecord {
        fn create_type() -> Option<anchor_lang::idl::types::IdlTypeDef> {
            Some(anchor_lang::idl::types::IdlTypeDef {
                name: Self::get_full_path(),
                docs: <[_]>::into_vec(::alloc::boxed::box_new(["Instruction.".into()])),
    ...
    impl borsh::de::BorshDeserialize for CreatePlaceholderRecord
    where
        u64: borsh::BorshDeserialize,
        String: borsh::BorshDeserialize,
        ValidityProof: borsh::BorshDeserialize,
    ...
    impl anchor_lang::Discriminator for CreatePlaceholderRecord {
        const DISCRIMINATOR: &'static [u8] = &[66, 70, 108, 128, 12, 105, 73, 250];
    }
    impl anchor_lang::InstructionData for CreatePlaceholderRecord {}
    impl anchor_lang::Owner for CreatePlaceholderRecord {
        fn owner() -> Pubkey {
            ID
        }
    }
    ...
    impl borsh::ser::BorshSerialize for UpdateGameSession
    where
        u64: borsh::ser::BorshSerialize,
        u64: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self._session_id, writer)?;
            borsh::BorshSerialize::serialize(&self.new_score, writer)?;
            Ok(())
        }
    }
    impl anchor_lang::idl::build::IdlBuild for UpdateGameSession {
        fn create_type() -> Option<anchor_lang::idl::types::IdlTypeDef> {
            Some(anchor_lang::idl::types::IdlTypeDef {
                name: Self::get_full_path(),
                docs: <[_]>::into_vec(::alloc::boxed::box_new(["Instruction.".into()])),
    ...
    impl borsh::de::BorshDeserialize for UpdateGameSession
    where
        u64: borsh::BorshDeserialize,
        u64: borsh::BorshDeserialize,
    {
        fn deserialize_reader<R: borsh::maybestd::io::Read>(
            ...
            Ok(Self {
                _session_id: borsh::BorshDeserialize::deserialize_reader(reader)?,
                new_score: borsh::BorshDeserialize::deserialize_reader(reader)?,
            })
        }
    }
    impl anchor_lang::Discriminator for UpdateGameSession {
        const DISCRIMINATOR: &'static [u8] = &[154, 197, 225, 250, 40, 214, 248, 224];
    }
    impl anchor_lang::InstructionData for UpdateGameSession {}
...
pub mod accounts {
    ...
    pub use crate::__client_accounts_update_game_session::*;
    pub use crate::__client_accounts_create_placeholder_record::*;
    ...
    pub use crate::__client_accounts_create_game_session::*;
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_create_record",
                        "CreateRecord",
                    ),
                );
                res
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info, CreatePlaceholderRecordBumps>
for CreatePlaceholderRecord<'info>
where
    'info: 'info,
{
    #[inline(never)]
    fn try_accounts(
        ...
        >],
        __ix_data: &[u8],
        __bumps: &mut CreatePlaceholderRecordBumps,
        __reallocs: &mut std::collections::BTreeSet<
            anchor_lang::solana_program::pubkey::Pubkey,
        >,
    ) -> anchor_lang::Result<Self> {
        ...
        impl anchor_lang::idl::build::IdlBuild for __Args {
            ...
            fn get_full_path() -> String {
                ::alloc::__export::must_use({
                    let res = ::alloc::fmt::format(
                        format_args!("{0}::{1}", "anchor_compressible_derived", "__Args"),
                    );
                    res
                })
            }
        ...
        let __Args { placeholder_id } = __Args::deserialize(&mut __ix_data)
        ...
        let placeholder_record = &__accounts[0];
        *__accounts = &__accounts[1..];
        let system_program: anchor_lang::accounts::program::Program<System> = anchor_lang::Accounts::try_accounts(
                __program_id,
                __accounts,
        ...
        __bumps.placeholder_record = __bump;
        if placeholder_record.key() != __pda_address {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintSeeds,
                    )
                    .with_account_name("placeholder_record")
                    .with_pubkeys((placeholder_record.key(), __pda_address)),
            );
        }
        let placeholder_record = ({
            #[inline(never)]
            || {
                let actual_field = AsRef::<AccountInfo>::as_ref(&placeholder_record);
                let actual_owner = actual_field.owner;
                let space = 8 + 10 + 32 + 4 + 32 + 8;
                let pa: anchor_lang::accounts::account::Account<PlaceholderRecord> = if !false
                    || actual_owner == &anchor_lang::solana_program::system_program::ID
                {
                    let __current_lamports = placeholder_record.lamports();
                    if __current_lamports == 0 {
                        let space = space;
                        let lamports = __anchor_rent.minimum_balance(space);
                        let cpi_accounts = anchor_lang::system_program::CreateAccount {
                            from: user.to_account_info(),
                            to: placeholder_record.to_account_info(),
                        };
                        let cpi_context = anchor_lang::context::CpiContext::new(
                            system_program.to_account_info(),
                            cpi_accounts,
                        ...
                        if user.key() == placeholder_record.key() {
                            return Err(
                                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                        error_name: anchor_lang::error::ErrorCode::TryingToInitPayerAsProgramAccount
                                            .name(),
                                    ...
                                    .with_pubkeys((user.key(), placeholder_record.key())),
                            );
                        }
                        let required_lamports = __anchor_rent
                            .minimum_balance(space)
                        ...
                        let cpi_accounts = anchor_lang::system_program::Allocate {
                            account_to_allocate: placeholder_record.to_account_info(),
                        };
                        let cpi_context = anchor_lang::context::CpiContext::new(
                            system_program.to_account_info(),
                            cpi_accounts,
                        ...
                        let cpi_accounts = anchor_lang::system_program::Assign {
                            account_to_assign: placeholder_record.to_account_info(),
                        };
                        let cpi_context = anchor_lang::context::CpiContext::new(
                            system_program.to_account_info(),
                            cpi_accounts,
                    ...
                    match anchor_lang::accounts::account::Account::try_from_unchecked(
                        ...
                        Ok(val) => val,
                        Err(e) => return Err(e.with_account_name("placeholder_record")),
                    }
                } else {
                    match anchor_lang::accounts::account::Account::try_from(
                        &placeholder_record,
        ...
        if !AsRef::<AccountInfo>::as_ref(&placeholder_record).is_writable {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintMut,
                    )
        ...
        if !__anchor_rent
            .is_exempt(
                placeholder_record.to_account_info().lamports(),
                placeholder_record.to_account_info().try_data_len()?,
            )
        {
            return Err(
                anchor_lang::error::Error::from(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for CreatePlaceholderRecord<'info>
where
    'info: 'info,
{
    fn to_account_infos(
        ...
        let mut account_infos = ::alloc::vec::Vec::new();
        account_infos.extend(self.user.to_account_infos());
        account_infos.extend(self.placeholder_record.to_account_infos());
        account_infos.extend(self.system_program.to_account_infos());
        account_infos.extend(self.config.to_account_infos());
        account_infos.extend(self.rent_recipient.to_account_infos());
        account_infos
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for CreatePlaceholderRecord<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
        let mut account_metas = ::alloc::vec::Vec::new();
        account_metas.extend(self.user.to_account_metas(None));
        account_metas.extend(self.placeholder_record.to_account_metas(None));
        account_metas.extend(self.system_program.to_account_metas(None));
        account_metas.extend(self.config.to_account_metas(None));
        account_metas.extend(self.rent_recipient.to_account_metas(None));
        account_metas
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for CreatePlaceholderRecord<'info>
where
    'info: 'info,
{
    fn exit(
        ...
        anchor_lang::AccountsExit::exit(&self.user, program_id)
            .map_err(|e| e.with_account_name("user"))?;
        anchor_lang::AccountsExit::exit(&self.placeholder_record, program_id)
            .map_err(|e| e.with_account_name("placeholder_record"))?;
        anchor_lang::AccountsExit::exit(&self.rent_recipient, program_id)
            .map_err(|e| e.with_account_name("rent_recipient"))?;
        Ok(())
    }
}
pub struct CreatePlaceholderRecordBumps {
    pub placeholder_record: u8,
}
#[automatically_derived]
impl ::core::fmt::Debug for CreatePlaceholderRecordBumps {
    #[inline]
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ::core::fmt::Formatter::debug_struct_field1_finish(
            f,
            "CreatePlaceholderRecordBumps",
            "placeholder_record",
            &&self.placeholder_record,
        )
    }
}
impl Default for CreatePlaceholderRecordBumps {
    fn default() -> Self {
        CreatePlaceholderRecordBumps {
            placeholder_record: u8::MAX,
        }
    }
}
impl<'info> anchor_lang::Bumps for CreatePlaceholderRecord<'info>
where
    'info: 'info,
{
    type Bumps = CreatePlaceholderRecordBumps;
}
/// An internal, Anchor generated module. This is used (as an
/// implementation detail), to generate a struct for a given
/// `#[derive(Accounts)]` implementation, where each field is a Pubkey,
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_create_placeholder_record {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`CreatePlaceholderRecord`].
    pub struct CreatePlaceholderRecord {
        pub user: Pubkey,
        pub placeholder_record: Pubkey,
        ///Needs to be here for the init anchor macro to work.
        pub system_program: Pubkey,
        ///The global config account
        pub config: Pubkey,
        ...
        Pubkey: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.user, writer)?;
            borsh::BorshSerialize::serialize(&self.placeholder_record, writer)?;
            borsh::BorshSerialize::serialize(&self.system_program, writer)?;
            borsh::BorshSerialize::serialize(&self.config, writer)?;
            borsh::BorshSerialize::serialize(&self.rent_recipient, writer)?;
            Ok(())
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_create_placeholder_record",
                        "CreatePlaceholderRecord",
                    ),
                );
                res
    ...
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for CreatePlaceholderRecord {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_create_placeholder_record {
    use super::*;
    /// Generated CPI struct of the accounts for [`CreatePlaceholderRecord`].
    pub struct CreatePlaceholderRecord<'info> {
        pub user: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub placeholder_record: anchor_lang::solana_program::account_info::AccountInfo<
            'info,
        >,
        ///Needs to be here for the init anchor macro to work.
        pub system_program: anchor_lang::solana_program::account_info::AccountInfo<
    ...
    impl<'info> anchor_lang::ToAccountMetas for CreatePlaceholderRecord<'info> {
        fn to_account_metas(
            ...
            account_metas
                .push(
                    anchor_lang::solana_program::instruction::AccountMeta::new(
                        anchor_lang::Key::key(&self.placeholder_record),
                        false,
                    ),
                );
            account_metas
...
impl<'info> CreatePlaceholderRecord<'info> {
    pub fn __anchor_private_gen_idl_accounts(
        accounts: &mut std::collections::BTreeMap<
            String,
            anchor_lang::idl::types::IdlAccount,
        ...
        if let Some(ty) = <PlaceholderRecord>::create_type() {
            let account = anchor_lang::idl::types::IdlAccount {
                name: ty.name.clone(),
                discriminator: PlaceholderRecord::DISCRIMINATOR.into(),
            };
            accounts.insert(account.name.clone(), account);
            types.insert(ty.name.clone(), ty);
            <PlaceholderRecord>::insert_types(types);
    ...
    fn try_accounts(
        ...
        *__accounts = &__accounts[1..];
        ...
        let compress_token_program_cpi_authority: UncheckedAccount = anchor_lang::Accounts::try_accounts(
            ...
            .map_err(|e| e.with_account_name("compress_token_program_cpi_authority"))?;
        let system_program: anchor_lang::accounts::program::Program<System> = anchor_lang::Accounts::try_accounts(
                __program_id,
                __accounts,
                __ix_data,
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for CreateUserRecordAndGameSession<'info>
where
    'info: 'info,
{
    fn to_account_infos(
...
impl<'info> anchor_lang::ToAccountMetas for CreateUserRecordAndGameSession<'info> {
    fn to_account_metas(
        ...
        account_metas
            .extend(self.compress_token_program_cpi_authority.to_account_metas(None));
        account_metas.extend(self.system_program.to_account_metas(None));
        account_metas.extend(self.config.to_account_metas(None));
        account_metas.extend(self.rent_recipient.to_account_metas(None));
        account_metas
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for CreateUserRecordAndGameSession<'info>
where
    'info: 'info,
{
    fn exit(
...
pub(crate) mod __client_accounts_create_user_record_and_game_session {
        ...
        Pubkey: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.compressed_token_program, writer)?;
            borsh::BorshSerialize::serialize(
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_create_user_record_and_game_session",
                        "CreateUserRecordAndGameSession",
                    ),
                );
                res
...
pub(crate) mod __cpi_client_accounts_create_user_record_and_game_session {
    ...
    pub struct CreateUserRecordAndGameSession<'info> {
        pub user: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub user_record: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub game_session: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        ///The mint signer used for PDA derivation
        pub mint_signer: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        ///The mint authority used for PDA derivation
    ...
    for CreateUserRecordAndGameSession<'info> {
        fn to_account_infos(
            ...
            account_infos
                .extend(
                    anchor_lang::ToAccountInfos::to_account_infos(&self.mint_authority),
                );
            account_infos
                .extend(
                    anchor_lang::ToAccountInfos::to_account_infos(
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info, CreateGameSessionBumps>
for CreateGameSession<'info>
where
    'info: 'info,
{
    #[inline(never)]
    fn try_accounts(
        ...
        >],
        __ix_data: &[u8],
        __bumps: &mut CreateGameSessionBumps,
        __reallocs: &mut std::collections::BTreeSet<
            anchor_lang::solana_program::pubkey::Pubkey,
        >,
    ) -> anchor_lang::Result<Self> {
        ...
        let __Args { session_id } = __Args::deserialize(&mut __ix_data)
            .map_err(|_| anchor_lang::error::ErrorCode::InstructionDidNotDeserialize)?;
        let player: Signer = anchor_lang::Accounts::try_accounts(
                __program_id,
                __accounts,
                __ix_data,
                __bumps,
        ...
        *__accounts = &__accounts[1..];
            ...
            || {
                    ...
                    || actual_owner == &anchor_lang::solana_program::system_program::ID
                {
                    ...
                    if __current_lamports == 0 {
                        ...
                        if player.key() == game_session.key() {
                            return Err(
                                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                        error_name: anchor_lang::error::ErrorCode::TryingToInitPayerAsProgramAccount
                                            .name(),
                                    ...
                                    .with_pubkeys((player.key(), game_session.key())),
                            );
                        }
                        let required_lamports = __anchor_rent
                            .minimum_balance(space)
        ...
        if !AsRef::<AccountInfo>::as_ref(&player).is_writable {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintMut,
                    )
                    .with_account_name("player"),
            );
        }
        if !&rent_recipient.is_writable {
            return Err(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for CreateGameSession<'info>
where
    'info: 'info,
{
    fn to_account_infos(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for CreateGameSession<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for CreateGameSession<'info>
where
    'info: 'info,
{
    fn exit(
        ...
        anchor_lang::AccountsExit::exit(&self.player, program_id)
            .map_err(|e| e.with_account_name("player"))?;
        anchor_lang::AccountsExit::exit(&self.game_session, program_id)
            .map_err(|e| e.with_account_name("game_session"))?;
        anchor_lang::AccountsExit::exit(&self.rent_recipient, program_id)
...
pub struct CreateGameSessionBumps {
    pub game_session: u8,
}
#[automatically_derived]
impl ::core::fmt::Debug for CreateGameSessionBumps {
    #[inline]
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ::core::fmt::Formatter::debug_struct_field1_finish(
            f,
            "CreateGameSessionBumps",
            "game_session",
            &&self.game_session,
        )
    }
}
impl Default for CreateGameSessionBumps {
    fn default() -> Self {
        CreateGameSessionBumps {
            game_session: u8::MAX,
        }
...
impl<'info> anchor_lang::Bumps for CreateGameSession<'info>
where
    'info: 'info,
{
    type Bumps = CreateGameSessionBumps;
}
/// An internal, Anchor generated module. This is used (as an
/// implementation detail), to generate a struct for a given
/// `#[derive(Accounts)]` implementation, where each field is a Pubkey,
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_create_game_session {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`CreateGameSession`].
    pub struct CreateGameSession {
        pub player: Pubkey,
        pub game_session: Pubkey,
        pub system_program: Pubkey,
    ...
    impl anchor_lang::idl::build::IdlBuild for CreateGameSession {
        fn create_type() -> Option<anchor_lang::idl::types::IdlTypeDef> {
            Some(anchor_lang::idl::types::IdlTypeDef {
                ...
                docs: <[_]>::into_vec(
                    ::alloc::boxed::box_new([
                        "Generated client accounts for [`CreateGameSession`].".into(),
                    ]),
                ),
                serialization: anchor_lang::idl::types::IdlSerialization::default(),
                repr: None,
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_create_game_session",
                        "CreateGameSession",
                    ),
                );
                res
    ...
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for CreateGameSession {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_create_game_session {
    use super::*;
    /// Generated CPI struct of the accounts for [`CreateGameSession`].
    pub struct CreateGameSession<'info> {
    ...
    impl<'info> anchor_lang::ToAccountInfos<'info> for CreateGameSession<'info> {
        fn to_account_infos(
            ...
            let mut account_infos = ::alloc::vec::Vec::new();
            account_infos
                .extend(anchor_lang::ToAccountInfos::to_account_infos(&self.player));
            account_infos
                .extend(
                    anchor_lang::ToAccountInfos::to_account_infos(&self.game_session),
                );
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_update_record",
                        "UpdateRecord",
                    ),
                );
                res
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info, UpdateGameSessionBumps>
for UpdateGameSession<'info>
where
    'info: 'info,
{
    #[inline(never)]
    fn try_accounts(
        ...
        >],
        __ix_data: &[u8],
        __bumps: &mut UpdateGameSessionBumps,
        __reallocs: &mut std::collections::BTreeSet<
            anchor_lang::solana_program::pubkey::Pubkey,
        >,
    ) -> anchor_lang::Result<Self> {
        ...
        let player: Signer = anchor_lang::Accounts::try_accounts(
            ...
            .map_err(|e| e.with_account_name("player"))?;
        let game_session: anchor_lang::accounts::account::Account<GameSession> = anchor_lang::Accounts::try_accounts(
                __program_id,
                __accounts,
                __ix_data,
                __bumps,
        ...
        if !(game_session.player == player.key()) {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintRaw,
                    )
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for UpdateGameSession<'info>
where
    'info: 'info,
{
    fn to_account_infos(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for UpdateGameSession<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for UpdateGameSession<'info>
where
    'info: 'info,
{
    fn exit(
...
pub struct UpdateGameSessionBumps {
    pub game_session: u8,
}
#[automatically_derived]
impl ::core::fmt::Debug for UpdateGameSessionBumps {
    #[inline]
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ::core::fmt::Formatter::debug_struct_field1_finish(
            f,
            "UpdateGameSessionBumps",
            "game_session",
            &&self.game_session,
        )
    }
}
impl Default for UpdateGameSessionBumps {
    fn default() -> Self {
        UpdateGameSessionBumps {
            game_session: u8::MAX,
        }
...
impl<'info> anchor_lang::Bumps for UpdateGameSession<'info>
where
    'info: 'info,
{
    type Bumps = UpdateGameSessionBumps;
}
/// An internal, Anchor generated module. This is used (as an
/// implementation detail), to generate a struct for a given
/// `#[derive(Accounts)]` implementation, where each field is a Pubkey,
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_update_game_session {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`UpdateGameSession`].
    pub struct UpdateGameSession {
        pub player: Pubkey,
        pub game_session: Pubkey,
    }
    ...
    impl anchor_lang::idl::build::IdlBuild for UpdateGameSession {
        fn create_type() -> Option<anchor_lang::idl::types::IdlTypeDef> {
            Some(anchor_lang::idl::types::IdlTypeDef {
                ...
                docs: <[_]>::into_vec(
                    ::alloc::boxed::box_new([
                        "Generated client accounts for [`UpdateGameSession`].".into(),
                    ]),
                ),
                serialization: anchor_lang::idl::types::IdlSerialization::default(),
                repr: None,
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_update_game_session",
                        "UpdateGameSession",
                    ),
                );
                res
    ...
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for UpdateGameSession {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_update_game_session {
    use super::*;
    /// Generated CPI struct of the accounts for [`UpdateGameSession`].
    pub struct UpdateGameSession<'info> {
        pub player: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub game_session: anchor_lang::solana_program::account_info::AccountInfo<'info>,
    }
...
impl<'info> UpdateGameSession<'info> {
    pub fn __anchor_private_gen_idl_accounts(
        accounts: &mut std::collections::BTreeMap<
            String,
            anchor_lang::idl::types::IdlAccount,
...
impl<'info> anchor_lang::ToAccountMetas for CompressAccountsIdempotent<'info> {
    fn to_account_metas(
        ...
        account_metas.extend(self.config.to_account_metas(None));
        account_metas.extend(self.rent_recipient.to_account_metas(None));
        account_metas.extend(self.token_compression_authority.to_account_metas(None));
        if let Some(compressed_token_program) = &self.compressed_token_program {
            account_metas.extend(compressed_token_program.to_account_metas(None));
        } else {
            account_metas.push(AccountMeta::new_readonly(crate::ID, false));
        ...
        if let Some(compressed_token_cpi_authority) = &self
            .compressed_token_cpi_authority
        {
            account_metas.extend(compressed_token_cpi_authority.to_account_metas(None));
        } else {
            account_metas.push(AccountMeta::new_readonly(crate::ID, false));
        }
        account_metas
    ...
    'info: 'info,
{
    fn exit(
        ...
        anchor_lang::AccountsExit::exit(&self.rent_recipient, program_id)
            .map_err(|e| e.with_account_name("rent_recipient"))?;
        anchor_lang::AccountsExit::exit(&self.token_compression_authority, program_id)
            .map_err(|e| e.with_account_name("token_compression_authority"))?;
        Ok(())
    }
}
...
pub(crate) mod __client_accounts_compress_accounts_idempotent {
        ...
        Option<Pubkey>: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.config, writer)?;
            borsh::BorshSerialize::serialize(&self.rent_recipient, writer)?;
            borsh::BorshSerialize::serialize(&self.token_compression_authority, writer)?;
            borsh::BorshSerialize::serialize(&self.compressed_token_program, writer)?;
            borsh::BorshSerialize::serialize(
                &self.compressed_token_cpi_authority,
                writer,
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_compress_accounts_idempotent",
                        "CompressAccountsIdempotent",
                    ),
                );
                res
...
pub(crate) mod __cpi_client_accounts_compress_accounts_idempotent {
    ...
    for CompressAccountsIdempotent<'info> {
        fn to_account_infos(
            ...
            let mut account_infos = ::alloc::vec::Vec::new();
            account_infos
                .extend(anchor_lang::ToAccountInfos::to_account_infos(&self.fee_payer));
            account_infos
                .extend(anchor_lang::ToAccountInfos::to_account_infos(&self.config));
            account_infos
                .extend(
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_initialize_compression_config",
                        "InitializeCompressionConfig",
                    ),
                );
                res
        ...
        <[_]>::into_vec(
            ::alloc::boxed::box_new([
                ...
                anchor_lang::idl::types::IdlInstructionAccountItem::Single(anchor_lang::idl::types::IdlInstructionAccount {
                    name: "program_data".into(),
                    docs: <[_]>::into_vec(
                        ::alloc::boxed::box_new(["The program's data account".into()]),
                    ),
                    writable: false,
                    signer: false,
                    optional: false,
        ...
        fn get_full_path() -> String {
            ::alloc::__export::must_use({
                let res = ::alloc::fmt::format(
                    format_args!(
                        "{0}::{1}",
                        "anchor_compressible_derived::__client_accounts_update_compression_config",
                        "UpdateCompressionConfig",
                    ),
                );
                res
    ...
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ::core::fmt::Formatter::write_str(
            ...
            match self {
                ...
                ErrorCode::CTokenDecompressionNotImplemented => {
                    "CTokenDecompressionNotImplemented"
                }
            },
        )
...
impl ErrorCode {
    ...
    pub fn name(&self) -> String {
        match self {
            ...
            ErrorCode::MintCreationFailed => "MintCreationFailed".to_string(),
            ErrorCode::MissingCompressedTokenProgram => {
                "MissingCompressedTokenProgram".to_string()
            }
            ErrorCode::MissingCompressedTokenProgramAuthorityPDA => {
                "MissingCompressedTokenProgramAuthorityPDA".to_string()
            }
            ErrorCode::CTokenDecompressionNotImplemented => {
    ...
    Option<Vec<(String, String)>>: borsh::BorshDeserialize,
{
    fn deserialize_reader<R: borsh::maybestd::io::Read>(
        ...
        Ok(Self {
            ...
            mint_update_authority: borsh::BorshDeserialize::deserialize_reader(reader)?,
            mint_freeze_authority: borsh::BorshDeserialize::deserialize_reader(reader)?,
...
impl anchor_lang::idl::build::IdlBuild for TokenAccountInfo {
    fn create_type() -> Option<anchor_lang::idl::types::IdlTypeDef> {
        Some(anchor_lang::idl::types::IdlTypeDef {
            ...
            docs: <[_]>::into_vec(
                ::alloc::boxed::box_new([
                    "Information about a token account to compress".into(),
                ]),
            ),
            serialization: anchor_lang::idl::types::IdlSerialization::default(),
            repr: None,
    ...
    CompressedMintWithContext: borsh::ser::BorshSerialize,
{
    fn serialize<W: borsh::maybestd::io::Write>(
        ...
        borsh::BorshSerialize::serialize(&self.user_output_state_tree_index, writer)?;
        ...
        borsh::BorshSerialize::serialize(&self.game_output_state_tree_index, writer)?;
    ...
    CompressedMintWithContext: borsh::BorshDeserialize,
{
    fn deserialize_reader<R: borsh::maybestd::io::Read>(
        ...
        Ok(Self {
            ...
            user_address_tree_info: borsh::BorshDeserialize::deserialize_reader(reader)?,
            ...
            game_address_tree_info: borsh::BorshDeserialize::deserialize_reader(reader)?,
