...
async fn decompress_pdas(
    ...
    let instruction =
        light_compressible_client::CompressibleInstruction::decompress_accounts_idempotent(
            program_id,
            &light_compressible_client::CompressibleInstruction::DECOMPRESS_ACCOUNTS_IDEMPOTENT_DISCRIMINATOR,
            ...
            &csdk_anchor_derived_test::accounts::DecompressAccountsIdempotent {
                ...
                ctoken_config: light_compressed_token_sdk::ctoken::config_pda(),
