        ...
        for (i, compressed_data) in compressed_accounts.into_iter().enumerate() {
            ...
            match compressed_data.data {
                CompressedAccountVariant::PackedUserRecord(packed) => {
                    light_sdk::compressible::handle_packed_pda_variant::<UserRecord, _>(
                        self.rent_payer.as_ref(),
                        cpi_accounts,
                        address_space,
                        &solana_accounts[i],
                ...
                CompressedAccountVariant::PackedGameSession(packed) => {
                    light_sdk::compressible::handle_packed_pda_variant::<GameSession, _>(
                        self.rent_payer.as_ref(),
                        cpi_accounts,
                        address_space,
                        &solana_accounts[i],
                ...
                CompressedAccountVariant::PackedPlaceholderRecord(packed) => {
                    light_sdk::compressible::handle_packed_pda_variant::<PlaceholderRecord, _>(
                        self.rent_payer.as_ref(),
                        cpi_accounts,
                        address_space,
                        &solana_accounts[i],
