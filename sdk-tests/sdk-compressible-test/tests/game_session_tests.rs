...
pub async fn decompress_single_game_session(
    ...
    let c_game_session =
        sdk_compressible_test::GameSession::deserialize(&mut &game_account_data.data[..]).unwrap();
    ...
    let instruction =
        light_compressible_client::CompressibleInstruction::decompress_accounts_idempotent(
            ...
            &[(
                c_game_pda,
                sdk_compressible_test::CompressedAccountVariant::GameSession(c_game_session),
            )],
