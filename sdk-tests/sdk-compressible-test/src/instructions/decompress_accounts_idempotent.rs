...
pub fn decompress_accounts_idempotent<'info>(
    ...
    fn process_tokens<'a, 'b, 'info>(
        ...
        let mut token_decompress_indices: Box<
            Vec<light_token_sdk::compressed_token::decompress_full::DecompressFullIndices>,
        ...
        for (token_data, meta) in ctoken_accounts.into_iter() {
                ...
                CreateTokenAccountCpi {
                    ...
                    compressible: Some(CompressibleParamsCpi {
                        ...
                        token_account_version:
                            light_token_interface::state::TokenDataVersion::ShaFlat,
                    }),
                }
            ...
            let decompress_index =
                light_token_sdk::compressed_token::decompress_full::DecompressFullIndices {
                    source,
