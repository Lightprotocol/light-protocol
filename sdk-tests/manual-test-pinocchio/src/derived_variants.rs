...
impl DecompressVariant<AccountInfo> for PackedLightAccountVariant {
    fn decompress(
        &self,
        tree_info: &PackedStateTreeInfo,
        pda_account: &AccountInfo,
        ctx: &mut DecompressCtx<'_>,
        ...
        match self {
            PackedLightAccountVariant::MinimalRecord { seeds, data } => {
                ...
                prepare_account_for_decompression::<4, PackedMinimalRecordVariant, AccountInfo>(
                    &packed_data,
                    tree_info,
                    output_queue_index,
                    pda_account,
            ...
            PackedLightAccountVariant::ZeroCopyRecord { seeds, data } => {
                ...
                prepare_account_for_decompression::<4, PackedZeroCopyRecordVariant, AccountInfo>(
                    &packed_data,
                    tree_info,
                    output_queue_index,
                    pda_account,
            ...
            PackedLightAccountVariant::AllBorsh { seeds, data } => {
                ...
                prepare_account_for_decompression::<3, PackedAllBorshVariant, AccountInfo>(
                    &packed_data,
                    tree_info,
                    output_queue_index,
                    pda_account,
            ...
            PackedLightAccountVariant::AllZeroCopy { seeds, data } => {
                ...
                prepare_account_for_decompression::<3, PackedAllZeroCopyVariant, AccountInfo>(
                    &packed_data,
                    tree_info,
                    output_queue_index,
                    pda_account,
