...
use sdk_light_token_pinocchio_test::{InstructionType, FREEZE_AUTHORITY_SEED};
use shared::*;
use solana_sdk::{
...
async fn test_freeze_invoke_signed() {
    ...
    let (pda_freeze_authority, _bump) =
        Pubkey::find_program_address(&[FREEZE_AUTHORITY_SEED], &PROGRAM_ID);
