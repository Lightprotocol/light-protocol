...
// RENT_SPONSOR constant for compile-time access to bump (kept for efficiency in on-chain code)
pub const RENT_SPONSOR: RentSponsor =
    derive_light_rent_sponsor!("FAMipfVEhN4hjCLpKCvjDXXfzLsoVTqQccXzePz1L1ah");

// Note: light_rent_sponsor() is auto-generated by #[light_program] macro below
