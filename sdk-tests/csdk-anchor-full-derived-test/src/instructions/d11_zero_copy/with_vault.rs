...
pub struct D11ZcWithVault<'info> {
    ...
    #[light_account(init, token::authority = [D11_ZC_VAULT_SEED, self.d11_mint.key()], token::mint = d11_mint, token::owner = d11_vault_authority, token::bump = params.vault_bump)]
