...
async fn test_amm_full_lifecycle() {
    ...
    // ==========================================================================
    // Note: Decompression requires the seed structs generated by #[rentfree_program]
    // macro. We would need to import them like:
    // use csdk_anchor_full_derived_test::csdk_anchor_full_derived_test::{
    //     PoolStateSeeds, ObservationStateSeeds, TokenAccountVariant
    // };
    //
    // For now, we verify that compression worked. Full decompression test
    // requires the macro-generated types to be available.

    println!("\nDecompression phase would use:");
    println!("  - get_account_info_interface for pool_state and observation_state");
    println!("  - get_token_account_interface for vaults");
    println!("  - get_ata_interface for creator_lp_token");
    println!("  - get_mint_interface for lp_mint");
    println!("  - create_load_accounts_instructions to generate decompression ixs");

    // TODO: Add full decompression test once seed structs are available
    // This would follow the pattern in basic_test.rs Phase 3
    ...
    println!("  - Decompression: TODO (requires seed struct types)");
}
