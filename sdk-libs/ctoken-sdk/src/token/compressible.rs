...
/// Parameters for creating compressible token accounts.
///
...
/// # Example
/// ```rust
/// use light_token_sdk::token::CompressibleParams;
///
...
/// Parameters for creating compressible token accounts via CPI.
///
/// # Example
/// ```rust,no_run
/// # use light_token_sdk::token::CompressibleParamsCpi;
/// # use solana_account_info::AccountInfo;
/// // Use token::COMPRESSIBLE_CONFIG_V1 or token::config_pda() to get the protocol config.
/// // Use token::RENT_SPONSOR or token::rent_sponsor_pda() to get the protocol rent sponsor.
