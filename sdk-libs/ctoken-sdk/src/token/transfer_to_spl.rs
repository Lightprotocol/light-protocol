...
/// # Create a transfer to SPL instruction:
/// ```rust
/// # use solana_pubkey::Pubkey;
...
/// # Transfer to SPL via CPI:
/// ```rust,no_run
/// # use light_token_sdk::token::TransferToSplCpi;
/// # use solana_account_info::AccountInfo;
...
impl TransferToSpl {
    ...
    pub fn instruction(self) -> Result<Instruction, ProgramError> {
        ...
        let compress_to_pool = CTokenAccount2 {
            ...
            compression: Some(Compression::compress_light_token(
                self.amount,
                0, // mint index
