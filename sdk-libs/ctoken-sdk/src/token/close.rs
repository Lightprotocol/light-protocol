...
use crate::token::RENT_SPONSOR;

/// # Create a close token account instruction:
/// ```rust
/// # use solana_pubkey::Pubkey;
/// # use light_token_sdk::token::{CloseAccount, CTOKEN_PROGRAM_ID};
/// # let account = Pubkey::new_unique();
/// # let destination = Pubkey::new_unique();
/// # let owner = Pubkey::new_unique();
/// let instruction =
///     CloseAccount::new(CTOKEN_PROGRAM_ID, account, destination, owner)
///     .instruction()?;
