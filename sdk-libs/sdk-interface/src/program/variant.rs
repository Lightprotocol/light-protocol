...
pub trait IntoVariant<V> {
    ...
    fn into_variant(self, data: &[u8]) -> Result<V, LightPdaError>;
}
    ...
    Sized + Clone + AnchorSerialize + AnchorDeserialize
{
    ...
    fn seed_refs_with_bump<'a, AI: AccountInfoTrait>(
        ...
        accounts: &'a [AI],
        bump_storage: &'a [u8; 1],
    ) -> Result<[&'a [u8]; SEED_COUNT], LightPdaError>;
    ...
    fn into_in_token_data(
        &self,
        tree_info: &light_sdk_types::instruction::PackedStateTreeInfo,
...
mod token_traits {
    ...
    use crate::{AnchorDeserialize, AnchorSerialize, error::LightPdaError};
