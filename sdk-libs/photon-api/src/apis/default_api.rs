...
pub async fn get_leaf_info_post(
    configuration: &configuration::Configuration,
    get_leaf_info_post_request: models::GetLeafInfoPostRequest,
) -> Result<models::GetLeafInfoPost200Response, Error<GetLeafInfoPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLeafInfoPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_proofs_by_indices_post(
    configuration: &configuration::Configuration,
    get_proofs_by_indices_post_request: models::GetProofsByIndicesPostRequest,
) -> Result<models::GetProofsByIndicesPost200Response, Error<GetProofsByIndicesPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProofsByIndicesPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_subtrees_post(
    configuration: &configuration::Configuration,
    get_subtrees_post_request: models::GetSubtreesPostRequest,
) -> Result<models::GetQueueElementsPost200Response, Error<GetSubtreesPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSubtreesPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
