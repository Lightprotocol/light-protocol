...
pub struct GetBatchAddressUpdateInfoPostRequest {
    ...
    pub method: Method,
    #[serde(rename = "params")]
    pub params: Box<models::GetBatchAddressUpdateInfoPostRequestParams>,
}
...
impl GetBatchAddressUpdateInfoPostRequest {
    pub fn new(
        ...
        jsonrpc: Jsonrpc,
        method: Method,
        params: models::GetBatchAddressUpdateInfoPostRequestParams,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum Method {
    #[serde(rename = "getBatchAddressUpdateInfo")]
    GetBatchAddressUpdateInfo,
}

impl Default for Method {
    fn default() -> Method {
        Self::GetBatchAddressUpdateInfo
    }
}
