...
pub struct GetCompressedTokenAccountsByOwnerV2PostRequest {
...
impl GetCompressedTokenAccountsByOwnerV2PostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetCompressedTokenAccountsByOwnerPostRequestParams) -> GetCompressedTokenAccountsByOwnerV2PostRequest {
