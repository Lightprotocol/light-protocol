...
pub struct GetCompressedAccountV2Post200Response {
    ...
    pub result: Option<Box<models::GetCompressedAccountV2Post200ResponseResult>>,
}

impl GetCompressedAccountV2Post200Response {
    pub fn new(id: Id, jsonrpc: Jsonrpc) -> GetCompressedAccountV2Post200Response {
