...
pub struct GetCompressedAccountsByOwnerV2PostRequest {
...
impl GetCompressedAccountsByOwnerV2PostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetCompressedAccountsByOwnerPostRequestParams) -> GetCompressedAccountsByOwnerV2PostRequest {
