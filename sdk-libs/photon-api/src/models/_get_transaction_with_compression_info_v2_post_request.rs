...
pub struct GetTransactionWithCompressionInfoV2PostRequest {
...
impl GetTransactionWithCompressionInfoV2PostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetTransactionWithCompressionInfoPostRequestParams) -> GetTransactionWithCompressionInfoV2PostRequest {
