...
impl MerkleProofWithContextV2 {
    pub fn new(account_hash: String, leaf: String, leaf_index: u64, merkle_tree: String, proof: Vec<String>, root: String, root_seq: u64) -> MerkleProofWithContextV2 {
