...
impl GetCompressedTokenBalancesByOwnerPostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetCompressedTokenAccountsByOwnerPostRequestParams) -> GetCompressedTokenBalancesByOwnerPostRequest {
