...
impl MerkleContextWithNewAddressProof {
    pub fn new(address: String, higher_range_address: String, low_element_leaf_index: u64, lower_range_address: String, merkle_tree: String, next_index: u64, proof: Vec<String>, root: String, root_seq: u64) -> MerkleContextWithNewAddressProof {
