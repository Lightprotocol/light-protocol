...
pub struct GetQueueElementsV2PostRequestParams {
    ...
    /// Optional override for the output queue ZKP batch size
    #[serde(
        rename = "outputQueueZkpBatchSize",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    /// Optional override for the address queue ZKP batch size
    #[serde(
        rename = "addressQueueZkpBatchSize",
        skip_serializing_if = "Option::is_none"
    )]
