...
pub struct GetCompressedTokenBalancesByOwnerV2PostRequest {
...
impl GetCompressedTokenBalancesByOwnerV2PostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetCompressedTokenAccountsByOwnerPostRequestParams) -> GetCompressedTokenBalancesByOwnerV2PostRequest {
