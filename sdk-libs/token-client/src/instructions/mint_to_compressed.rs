...
use light_compressed_token_sdk::{
    instructions::{
        create_mint_to_compressed_instruction, derive_compressed_mint_from_spl_mint, DecompressedMintConfig, MintToCompressedInputs,
    },
...
pub async fn mint_to_compressed_instruction<R: Rpc + Indexer>(
    ...
    let compressed_mint_address = derive_compressed_mint_from_spl_mint(
        &spl_mint_pda,
        &address_tree_pubkey,
    );
