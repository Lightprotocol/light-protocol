...
pub struct DecompressInput {
    ...
    pub in_tlv:
        Option<Vec<Vec<light_ctoken_types::instructions::extensions::ExtensionInstructionData>>>,
}
...
pub async fn create_generic_transfer2_instruction<R: Rpc + Indexer>(
    ...
    let mut collected_in_tlv: Vec<
        Vec<light_ctoken_types::instructions::extensions::ExtensionInstructionData>,
    > = Vec::new();
