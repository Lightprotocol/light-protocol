...
pub fn validate_compress_accounts<AI: AccountInfoTrait + Clone>(
    ...
    program_id: &[u8; 32],
) -> Result<ValidatedPdaContext<AI>, LightSdkTypesError> {
...
) -> Result<(&[AI], &[AI]), LightSdkTypesError> {
...
pub fn is_pda_initialized<AI: AccountInfoTrait>(account: &AI) -> Result<bool, LightSdkTypesError> {
