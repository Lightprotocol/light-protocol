...
pub enum PackedLightAccountMeta {
    Init(PackedInitLightAccountMeta),
    Mut(PackedMutLightAccountMeta),
    Close(PackedCloseLightAccountMeta),
}
...
#[derive(Debug, Clone, AnchorSerialize, AnchorDeserialize, PartialEq, Default)]
pub struct PackedInitLightAccountMeta {
...
#[derive(Debug, Clone, AnchorSerialize, AnchorDeserialize, PartialEq, Default)]
pub struct PackedMutLightAccountMeta {
    pub lamports: u64,
    pub address: [u8; 32],
    pub data: Vec<u8>,
...
#[derive(Debug, Clone, AnchorSerialize, AnchorDeserialize, PartialEq, Default)]
pub struct PackedCloseLightAccountMeta {
    pub lamports: u64,
    pub address: [u8; 32],
    pub data: Vec<u8>,
    pub merkle_context: PackedMerkleContext,
