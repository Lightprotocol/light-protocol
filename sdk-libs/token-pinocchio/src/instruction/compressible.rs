...
pub struct CompressibleParams {
    ...
    /// Number of lamports transferred on a write operation (eg transfer) when account rent is
    /// insufficient to cover the next 2 rent-epochs.
...
impl CompressibleParams {
    ...
    /// - Protocol rent sponsor
    /// - TokenDataVersion::ShaFlat token data hashing
    pub fn new() -> Self {
        Self::default()
    }
