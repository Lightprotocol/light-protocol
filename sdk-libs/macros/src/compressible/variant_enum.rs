...
pub fn compressed_account_variant(input: TokenStream) -> Result<TokenStream> {
    ...
    let enum_def = quote! {
        ...
        pub enum CompressedAccountVariant {
            #(#account_variants)*
            PackedCTokenData(light_token_sdk::compat::PackedTokenDataWithVariant<CTokenAccountVariant>),
            CTokenData(light_token_sdk::compat::TokenDataWithVariant<CTokenAccountVariant>),
        }
    };
