...
use light_ctoken_types::{
    self,
    instructions::{
        create_compressed_mint::{CompressedMintWithContext, CpiContext},
...
pub fn create_compressed_mint_cpi(
    ...
    let cpi_context_pubkey = cpi_context
        .as_ref()
        .map(|ctx| solana_pubkey::Pubkey::from(ctx.cpi_context_pubkey.to_bytes()));
