    ...
    for action in input.actions {
        match action {
            ...
            MintActionType::UpdateMetadataField {
                ...
                program_actions.push(
                    light_ctoken_types::instructions::mint_actions::Action::UpdateMetadataField(
                        UpdateMetadataFieldAction {
                            extension_index,
                            field_type,
                            key,
            ...
            MintActionType::UpdateMetadataAuthority {
                ...
                program_actions.push(
                    light_ctoken_types::instructions::mint_actions::Action::UpdateMetadataAuthority(
                        UpdateMetadataAuthorityAction {
                            extension_index,
                            new_authority: new_authority.to_bytes().into(),
                        },
            ...
            MintActionType::RemoveMetadataKey {
                ...
                program_actions.push(
                    light_ctoken_types::instructions::mint_actions::Action::RemoveMetadataKey(
