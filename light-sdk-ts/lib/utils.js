...
exports.fetchAssetByIdLookUp =
  exports.getAssetIndex =
  exports.assetLookupTable =
...
function getAssetLookUpId({ connection, asset }) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let registeredAssets =
      yield mtConf.merkleTreeProgram.account.registeredAssetPool.fetch(
        pubkey.pda
      );
...
exports.assetLookupTable = [web3_js_1.SystemProgram.programId, index_1.MINT];
function getAssetIndex(assetPubkey) {
  return exports.assetLookupTable.findIndex((v, i) => {
    console.log(`${v} == ${assetPubkey}`);
    console.log(`${v.toBase58()} == ${assetPubkey.toBase58()}`);
    if (v.toBase58() == assetPubkey.toBase58()) {
