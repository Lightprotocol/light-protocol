...
exports.MERKLE_TREE_INIT_AUTHORITY = [2, 99, 226, 251, 88, 66, 92, 33, 25, 216, 211, 185, 112, 203, 212, 238, 105, 144, 72, 121, 176,
...
exports.ADMIN_AUTH_KEY = new solana.PublicKey(new Uint8Array(exports.MERKLE_TREE_INIT_AUTHORITY));
exports.ADMIN_AUTH_KEYPAIR = solana.Keypair.fromSecretKey(new Uint8Array(exports.PRIVATE_KEY));
...
exports.userTokenAccount = new solana.PublicKey("CfyD2mSomGrjnyMKWrgNEk1ApaaUvKRDsnQngGkCVTFk");
exports.recipientTokenAccount = new solana.PublicKey("6RtYrpXTyH98dvTf9ufivkyDG8mF48oMDbhiRW9r5KjD");
...
exports.USER_TOKEN_ACCOUNT = solana.Keypair.fromSecretKey(new Uint8Array([
...
exports.RECIPIENT_TOKEN_ACCOUNT = solana.Keypair.fromSecretKey(new Uint8Array([
...
exports.MERKLE_TREE_KEY = new solana.PublicKey("DCxUdYgqjE6AR9m13VvqpkxJqGJYnk8jn8NEeD3QY3BU");
exports.REGISTERED_VERIFIER_PDA = new solana.PublicKey("Eo3jtUstuMCvapqXdWiYvoUJS1PJDtKVf6LdsMPdyoNn");
exports.REGISTERED_VERIFIER_ONE_PDA = new solana.PublicKey("CqUS5VyuGscwLMTbfUSAA1grmJYzDAkSR39zpbwW2oV5");
exports.REGISTERED_VERIFIER_TWO_PDA = new solana.PublicKey("7RCgKAJkaR4Qsgve8D7Q3MrVt8nVY5wdKsmTYVswtJWn");
exports.AUTHORITY = new solana.PublicKey("KitaXMAzb8GPZcc6NW6mE7P6gV2fY3Bp8NqZWfeUwqM");
exports.AUTHORITY_ONE = new solana.PublicKey("EjGpk73m5KxndbUVXcoT3UQsPLp5eK4h1H8kXVHEbf3f");
exports.PRE_INSERTED_LEAVES_INDEX = new solana.PublicKey("2MQ7XkirVZZhRQQKcaDiJsrXHCuRHjbu72sUEeW4eZjq");
exports.TOKEN_AUTHORITY = new solana.PublicKey("GUqBxNbKyB9SBnbBKYR5dajwuWTjTRUhWrZgeFkJND55");
exports.REGISTERED_POOL_PDA_SPL = new solana.PublicKey("2q4tXrgpsDffibmjfTGHU1gWCjYUfhwFnMyLX6dAhhr4");
exports.REGISTERED_POOL_PDA_SPL_TOKEN = new solana.PublicKey("2mobV36eNyFGaMTKCHW1Jeoq64tUGuXqA4zGtY8SbxKh");
exports.REGISTERED_POOL_PDA_SOL = new solana.PublicKey("Eti4Rjkx7ow88XkaFbxRStmwadTp8p9J2nSv7NhtuqDU");
