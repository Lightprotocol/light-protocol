...
// -
function testTransaction({ transaction, deposit = true, enabledSignerTest = true, provider, signer, ASSET_1_ORG, REGISTERED_VERIFIER_ONE_PDA, REGISTERED_VERIFIER_PDA }) {
    return __awaiter(this, void 0, void 0, function* () {
        const origin = yield (0, createAccounts_1.newAccountWithLamports)(provider.connection);
        ...
        (0, chai_1.assert)(e.logs.includes('Program log: error ProofVerificationFailed') == true);
        transaction.publicInputs.publicAmount = _.cloneDeep(shieldedTxBackUp.publicInputs.publicAmount);
        yield (0, testChecks_1.checkNfInserted)(transaction.nullifierPdaPubkeys, provider.connection);
        // Wrong feeAmount
        ...
        yield (0, createAccounts_1.createMint)({
            authorityKeypair: signer,
            mintKeypair: ASSET_1_ORG,
            provider
        });
        transaction.sender = yield (0, createAccounts_1.newAccountWithTokens)({ connection: provider.connection,
        ...
        if (enabledSignerTest) {
            ...
            (0, chai_1.assert)(e.logs.includes('Program log: error ProofVerificationFailed') == true || e.logs.includes('Program log: AnchorError caused by account: signing_address. Error Code: ConstraintAddress. Error Number: 2012. Error Message: An address constraint was violated.') == true);
        ...
        if (deposit == true) {
            ...
            (0, chai_1.assert)(e.logs.includes('Program log: AnchorError thrown in src/light_transaction.rs:696. Error Code: InvalidSenderorRecipient. Error Number: 6011. Error Message: InvalidSenderorRecipient.') == true);
        ...
        (0, chai_1.assert)(e.logs.includes('Program log: AnchorError caused by account: registered_verifier_pda. Error Code: ConstraintSeeds. Error Number: 2006. Error Message: A seeds constraint was violated.') == true);
        ...
        (0, chai_1.assert)(e.logs.includes('Program log: AnchorError caused by account: authority. Error Code: ConstraintSeeds. Error Number: 2006. Error Message: A seeds constraint was violated.') == true);
        ...
        for (var j = 0; j < transaction.nullifierPdaPubkeys.length; j++) {
            ...
            (0, chai_1.assert)(transaction.nullifierPdaPubkeys[j] != shieldedTxBackUp.nullifierPdaPubkeys[j]);
            e = yield transaction.sendTransaction();
            console.log(e);
            ...
            (0, chai_1.assert)(e.logs.includes('Program log: Passed-in pda pubkey != on-chain derived pda pubkey.') == true);
