...
exports.executeMerkleTreeUpdateTransactions =
  exports.executeUpdateMerkleTreeTransactions = void 0;
const anchor = __importStar(require("@coral-xyz/anchor"));
const testChecks_1 = require("../test-utils/testChecks");
const index_1 = require("../index");
const web3_js_1 = require("@solana/web3.js");
function executeUpdateMerkleTreeTransactions({
  signer,
  merkleTreeProgram,
  leavesPdas,
  merkleTree,
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let merkleTreeUpdateState =
      (yield web3_js_1.PublicKey.findProgramAddressSync(
        [
...
exports.executeUpdateMerkleTreeTransactions =
  executeUpdateMerkleTreeTransactions;
function executeMerkleTreeUpdateTransactions({
  merkleTreeProgram,
  merkleTreeUpdateState,
  merkle_tree_pubkey,
  provider,
    ...
    yield Promise.all(
      arr.map((tx, index) =>
        __awaiter(this, void 0, void 0, function* () {
          try {
            yield provider.sendAndConfirm(
              tx.tx,
              tx.signers,
              index_1.confirmConfig
            );
          } catch (e) {
            console.log(e);
            error = e;
