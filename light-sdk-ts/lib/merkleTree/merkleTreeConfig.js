...
class MerkleTreeConfig {
    constructor({ merkleTreePubkey, payer, connection, }) {
        ...
        this.payer = payer;
        this.merkleTreeProgram = new anchor_1.Program(merkle_tree_program_1.IDL_MERKLE_TREE_PROGRAM, index_1.merkleTreeProgramId);
    ...
    getPreInsertedLeavesIndex() {
        return __awaiter(this, void 0, void 0, function* () {
            this.preInsertedLeavesIndex = web3_js_1.PublicKey.findProgramAddressSync([this.merkleTreePubkey.toBuffer()], this.merkleTreeProgram.programId)[0];
    ...
    getPoolTypePda(poolType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // TODO: add check whether already exists
            this.poolTypes.push({
                poolPda: web3_js_1.PublicKey.findProgramAddressSync([poolType, anchor.utils.bytes.utf8.encode("pooltype")], this.merkleTreeProgram.programId)[0],
                poolType: poolType,
            });
    ...
    static getSolPoolPda(programId, poolType = new Uint8Array(32)) {
        return {
    ...
    static getSplPoolPdaToken(mint, programId, poolType = new Uint8Array(32).fill(0)) {
        let pda = web3_js_1.PublicKey.findProgramAddressSync([mint.toBytes(), poolType, anchor.utils.bytes.utf8.encode("pool")], programId)[0];
        return pda;
    }
    getSplPoolPda(mint, poolType = new Uint8Array(32).fill(0)) {
        return __awaiter(this, void 0, void 0, function* () {
            this.poolPdas.push({
                pda: web3_js_1.PublicKey.findProgramAddressSync([
                    mint.toBytes(),
                ...
                poolType: poolType,
                token: yield MerkleTreeConfig.getSplPoolPdaToken(mint, this.merkleTreeProgram.programId, poolType),
            });
    ...
    registerSplPool(poolType, mint) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let splPoolPda = yield this.getSplPoolPda(mint, poolType);
