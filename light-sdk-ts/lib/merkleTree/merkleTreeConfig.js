...
class MerkleTreeConfig {
  ...
  checkPreInsertedLeavesIndexIsInitialized() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      (0,
      chai_1.assert)(preInsertedLeavesIndexAccountInfo.nextIndex.toString() == "0");
    });
  }
  printMerkleTree() {
    return __awaiter(this, void 0, void 0, function* () {
  ...
  initMerkleTreeAuthority(authority) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      (0,
      chai_1.assert)(merkleTreeAuthority.pubkey.toBase58() == authority.publicKey.toBase58());
      (0,
      chai_1.assert)(merkleTreeAuthority.registeredAssetIndex.toString() == "0");
      return tx;
    });
  }
  ...
  getRegisteredVerifierPda(verifierPubkey) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return this
        .registeredVerifierPdas[this.registeredVerifierPdas.length - 1];
    });
  }
  ...
  checkVerifierIsRegistered(verifierPubkey) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      (0,
      chai_1.assert)(registeredVerifierAccountInfo.pubkey.toBase58() == verifierPubkey.toBase58());
    });
  }
  ...
  checkPoolRegistered(poolPda, poolType, mint = null) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      (0,
      chai_1.assert)(registeredTokenConfigAccount.index.toString() == (merkleTreeAuthorityPdaAccountInfo.registeredAssetIndex - 1).toString());
      if (mint !== null) {
        (0, chai_1.assert)(
