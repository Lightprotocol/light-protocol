...
function testTransaction({ transaction, deposit = true, enabledSignerTest = true, provider, signer, ASSET_1_ORG, REGISTERED_VERIFIER_ONE_PDA, REGISTERED_VERIFIER_PDA, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log("transaction.verifier.registeredVerifierPda ", transaction.verifier.registeredVerifierPda);
        console.log("REGISTERED_VERIFIER_ONE_PDA ", REGISTERED_VERIFIER_ONE_PDA);
        // Wrong registeredVerifierPda
        if (transaction.verifier.registeredVerifierPda.toBase58() ==
        ...
        for (var j = 0; j < transaction.nullifierPdaPubkeys.length; j++) {
            ...
            transaction.nullifierPdaPubkeys[j] =
                transaction.nullifierPdaPubkeys[(j + 1) % transaction.nullifierPdaPubkeys.length];
            (0, chai_1.assert)(transaction.nullifierPdaPubkeys[j] !=
