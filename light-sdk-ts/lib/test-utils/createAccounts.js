...
const newAccountWithLamports = (connection, account = new anchor.web3.Account(), lamports = 1e10) => __awaiter(void 0, void 0, void 0, function* () {
    let x = yield connection.confirmTransaction(yield connection.requestAirdrop(account.publicKey, lamports), {
...
const newProgramOwnedAccount = ({ connection, owner, lamports = 0 }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (retry < 30) {
        try {
            yield connection.confirmTransaction(yield connection.requestAirdrop(payer.publicKey, 1e7), {
                commitment: 'comfirmed',
                preflightCommitment: 'comfirmed',
            });
...
function createMintWrapper({ authorityKeypair, mintKeypair = new web3_js_1.Keypair(), nft = false, decimals = 2, connection }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let res = yield (0, web3_js_1.sendAndConfirmTransaction)(connection, txCreateAccount, [authorityKeypair, mintKeypair], constants_1.confirmConfig);
...
function createTestAccounts(connection) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let balance = yield connection.getBalance(constants_1.ADMIN_AUTH_KEY, "confirmed");
        if (balance === 0) {
            let amount = 1000000000000;
            console.time("requestAirdrop");
            let res = yield connection.requestAirdrop(constants_1.ADMIN_AUTH_KEY, amount);
            ...
            let txTransfer1 = new solana.Transaction().add(solana.SystemProgram.transfer({ fromPubkey: constants_1.ADMIN_AUTH_KEYPAIR.publicKey, toPubkey: constants_1.AUTHORITY, lamports: 1000000000 }));
            yield (0, web3_js_1.sendAndConfirmTransaction)(connection, txTransfer1, [constants_1.ADMIN_AUTH_KEYPAIR], constants_1.confirmConfig);
        }
        if ((yield connection.getBalance(solana.Keypair.fromSecretKey(constants_1.MINT_PRIVATE_KEY).publicKey, "confirmed")) == 0) {
            yield createMintWrapper({
                authorityKeypair: constants_1.ADMIN_AUTH_KEYPAIR,
                mintKeypair: web3_js_1.Keypair.fromSecretKey(constants_1.MINT_PRIVATE_KEY),
                connection
            });
        ...
        try {
            balanceUserToken = yield (0, spl_token_1.getAccount)(connection, constants_1.userTokenAccount, "confirmed", spl_token_1.TOKEN_PROGRAM_ID);
        }
        catch (e) {
        }
