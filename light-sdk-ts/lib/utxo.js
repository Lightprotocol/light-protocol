...
class Utxo {
  ...
  toBytes() {
    ...
    console.log("getAssetIndex ", this.assets[1]);
    console.log("MINT ", index_1.MINT);
  ...
  encrypt() {
    ...
    const ciphertext = (0, tweetnacl_1.box)(
      ...
      constants_1.CONSTANT_SECRET_AUTHKEY
    );
