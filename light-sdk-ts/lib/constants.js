...
exports.FEE_ASSET =
  ...
  exports.FIELD_SIZE =
  exports.CONSTANT_SECRET_AUTHKEY =
    void 0;
...
exports.MERKLE_TREE_KEY = new web3_js_1.PublicKey(
  "DCxUdYgqjE6AR9m13VvqpkxJqGJYnk8jn8NEeD3QY3BU"
);
exports.REGISTERED_VERIFIER_PDA = new web3_js_1.PublicKey(
  "Eo3jtUstuMCvapqXdWiYvoUJS1PJDtKVf6LdsMPdyoNn"
);
exports.REGISTERED_VERIFIER_ONE_PDA = new web3_js_1.PublicKey(
  "CqUS5VyuGscwLMTbfUSAA1grmJYzDAkSR39zpbwW2oV5"
);
exports.REGISTERED_VERIFIER_TWO_PDA = new web3_js_1.PublicKey(
  "7RCgKAJkaR4Qsgve8D7Q3MrVt8nVY5wdKsmTYVswtJWn"
);
exports.AUTHORITY = new web3_js_1.PublicKey(
  "KitaXMAzb8GPZcc6NW6mE7P6gV2fY3Bp8NqZWfeUwqM"
);
exports.AUTHORITY_ONE = new web3_js_1.PublicKey(
  "EjGpk73m5KxndbUVXcoT3UQsPLp5eK4h1H8kXVHEbf3f"
);
exports.PRE_INSERTED_LEAVES_INDEX = new web3_js_1.PublicKey(
  "2MQ7XkirVZZhRQQKcaDiJsrXHCuRHjbu72sUEeW4eZjq"
);
exports.TOKEN_AUTHORITY = new web3_js_1.PublicKey(
  "GUqBxNbKyB9SBnbBKYR5dajwuWTjTRUhWrZgeFkJND55"
);
exports.REGISTERED_POOL_PDA_SPL = new web3_js_1.PublicKey(
  "2q4tXrgpsDffibmjfTGHU1gWCjYUfhwFnMyLX6dAhhr4"
);
exports.REGISTERED_POOL_PDA_SPL_TOKEN = new web3_js_1.PublicKey(
  "2mobV36eNyFGaMTKCHW1Jeoq64tUGuXqA4zGtY8SbxKh"
);
exports.REGISTERED_POOL_PDA_SOL = new web3_js_1.PublicKey(
  "Eti4Rjkx7ow88XkaFbxRStmwadTp8p9J2nSv7NhtuqDU"
);
exports.POOL_TYPE = new Uint8Array(32).fill(0);
exports.MERKLE_TREE_AUTHORITY_PDA = new web3_js_1.PublicKey(
