...
class VerifierZero {
  ...
  initVerifierProgram() {
    this.verifierProgram = new anchor_1.Program(
      verifier_program_zero_1.VerifierProgramZero,
  ...
  sendTransaction(transaction) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        transaction.recipientBalancePriorTx = (yield (0,
        spl_token_1.getAccount)(
        ...
        try {
          transaction.recipientBalancePriorTx =
            yield transaction.provider.connection.getBalance(
              transaction.recipient
            );
        } catch (e) {}
      }
      ...
      const ix = yield transaction.verifier.verifierProgram.methods
        ...
        .instruction();
      let recentBlockhash =
        (yield transaction.provider.connection.getRecentBlockhash("confirmed"))
          .blockhash;
      ...
      let lookupTableAccount =
        yield transaction.provider.connection.getAccountInfo(
      ...
      while (retries > 0) {
        ...
        recentBlockhash =
          (yield transaction.provider.connection.getRecentBlockhash(
            "confirmed"
          )).blockhash;
        try {
