...
class VerifierOne {
    ...
    transferSecond(transfer) {
        return __awaiter(this, void 0, void 0, function* () {
            const ix = yield transfer.verifier.verifierProgram.methods.shieldedTransferSecond(Buffer.from(transfer.proofBytes)).accounts({
                signingAddress: transfer.relayerPubkey,
                verifierState: transfer.verifierStatePubkey,
                systemProgram: web3_js_1.SystemProgram.programId,
            ...
            while (retries > 0) {
                ...
                try {
                    ...
                    if (retries == 0 || e.logs != undefined) {
                        const ixClose = yield transfer.verifier.verifierProgram.methods.closeVerifierState().accounts({
                            signingAddress: transfer.relayerPubkey,
                            verifierState: transfer.verifierStatePubkey
                        })
    ...
    sendTransaction(insert = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let balance = yield this.provider.connection.getBalance(this.signerAuthorityPubkey, { preflightCommitment: "confirmed", commitment: "confirmed" });
            if (balance === 0) {
                yield this.provider.connection.confirmTransaction(yield this.provider.connection.requestAirdrop(this.signerAuthorityPubkey, 1000000000), { preflightCommitment: "confirmed", commitment: "confirmed" });
            }
            try {
