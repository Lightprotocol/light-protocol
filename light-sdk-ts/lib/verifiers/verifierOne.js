...
class VerifierOne {
    ...
    transferFirst(transfer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log("transfer.publicInputs.publicAmount: ", transfer.publicInputs.publicAmount);
            console.log("transfer.publicInputs.nullifiers: ", transfer.publicInputs.nullifiers);
            console.log("transfer.publicInputs.leaves[0]: ", transfer.publicInputs.leaves[0]);
            console.log("transfer.publicInputs.feeAmount: ", transfer.publicInputs.feeAmount);
            console.log("transfer.rootIndex.toString(): ", transfer.rootIndex);
            console.log("transfer.publicInputs.feeAmount: ", transfer.publicInputs.feeAmount);
            console.log("transfer.publicInputs.relayerFee.toString(): ", transfer.relayerFee.toString());
            console.log("transfer.publicInputs.encryptedUtxos: ", transfer.encryptedUtxos);
            ...
            console.log("transfer.signerAuthorityPubkey: ", transfer.signerAuthorityPubkey.toBase58());
            console.log("transfer.tokenAuthority: ", transfer.tokenAuthority.toBase58());
            ...
            console.log("transfer.relayerRecipient: ", transfer.relayerRecipient.toBase58());
            console.log("transfer.escrow: ", transfer.escrow.toBase58());
            console.log("transfer.registeredVerifierPda: ", transfer.verifier.registeredVerifierPda.toBase58());
            const ix1 = yield transfer.verifier.verifierProgram.methods
                .shieldedTransferFirst(Buffer.from(transfer.publicInputs.publicAmount), transfer.publicInputs.nullifiers, transfer.publicInputs.leaves[0], Buffer.from(transfer.publicInputs.feeAmount), new anchor.BN(transfer.rootIndex.toString()), new anchor.BN(transfer.relayerFee.toString()), Buffer.from(transfer.encryptedUtxos))
                .accounts({
    ...
    transferSecond(transfer) {
        return __awaiter(this, void 0, void 0, function* () {
            const ix = yield transfer.verifier.verifierProgram.methods
                ...
                .signers([transfer.payer])
                .instruction();
            let recentBlockhash = (yield transfer.provider.connection.getRecentBlockhash("confirmed")).blockhash;
            ...
            let lookupTableAccount = yield transfer.provider.connection.getAccountInfo(transfer.lookupTable, "confirmed");
            ...
            while (retries > 0) {
                ...
                recentBlockhash = (yield transfer.provider.connection.getRecentBlockhash("confirmed")).blockhash;
                transaction.message.recentBlockhash = recentBlockhash;
                let serializedTx = transaction.serialize();
                try {
                    console.log("serializedTx: ");
                    res = yield (0, web3_js_1.sendAndConfirmRawTransaction)(transfer.provider.connection, serializedTx, {
                        commitment: "confirmed",
                        preflightCommitment: "confirmed",
                    });
                    retries = 0;
    ...
    sendTransaction(transfer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let balance = yield transfer.provider.connection.getBalance(transfer.signerAuthorityPubkey, { preflightCommitment: "confirmed", commitment: "confirmed" });
            if (balance === 0) {
                yield transfer.provider.connection.confirmTransaction(yield transfer.provider.connection.requestAirdrop(transfer.signerAuthorityPubkey, 1000000000), { preflightCommitment: "confirmed", commitment: "confirmed" });
            }
            try {
                transfer.recipientBalancePriorTx = (yield (0, spl_token_1.getAccount)(transfer.provider.connection, transfer.recipient, spl_token_1.TOKEN_PROGRAM_ID)).amount;
            }
            catch (error) { }
            ...
            transfer.relayerRecipientAccountBalancePriorLastTx =
                yield transfer.provider.connection.getBalance(transfer.relayerRecipient);
            ...
            console.log("transfer.verifierStatePubkey, ", transfer.verifierStatePubkey.toBase58());
            // console.log("transfer.publicInputs.nullifiers, ", transfer.publicInputs.nullifiers);
