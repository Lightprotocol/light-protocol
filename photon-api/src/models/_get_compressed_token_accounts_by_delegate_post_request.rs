...
impl GetCompressedTokenAccountsByDelegatePostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetCompressedTokenAccountsByDelegatePostRequestParams) -> GetCompressedTokenAccountsByDelegatePostRequest {
