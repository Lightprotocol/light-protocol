...
pub struct GetCompressedTokenBalancesByOwnerPostRequest {
    ...
    pub method: Method,
    #[serde(rename = "params")]
    pub params: Box<models::GetCompressedTokenBalancesByOwnerPostRequestParams>,
}

impl GetCompressedTokenBalancesByOwnerPostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetCompressedTokenBalancesByOwnerPostRequestParams) -> GetCompressedTokenBalancesByOwnerPostRequest {
