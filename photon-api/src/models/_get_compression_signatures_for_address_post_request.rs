...
impl GetCompressionSignaturesForAddressPostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetCompressionSignaturesForAddressPostRequestParams) -> GetCompressionSignaturesForAddressPostRequest {
