...
impl GetTransactionWithCompressionInfoPostRequest {
    pub fn new(id: Id, jsonrpc: Jsonrpc, method: Method, params: models::GetTransactionWithCompressionInfoPostRequestParams) -> GetTransactionWithCompressionInfoPostRequest {
