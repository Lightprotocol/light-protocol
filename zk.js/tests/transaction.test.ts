...
describe("Transaction Functional Tests", () => {
  ...
  it("getConnectingHash", async () => {
    ...
    assert.equal(
      ...
      "172425708222997858302813094187604766503776835838244719822913659667694128524",
    );
    assert.equal(
      paramsStaticEncryptedUtxos.getTransactionHash(poseidon).toString(),
      "6125333719279428443022685614819778288665736787084989823442221342372328974291",
    );
  });
