...
export const IDL: LightMerkleTreeProgram = {
  ...
  constants: [
    ...
    },
    {
      ...
      type: "bytes",
      value:
        "[101, 118, 101, 110, 116, 95, 109, 101, 114, 107, 108, 101, 95, 116, 114, 101, 101]",
    },
    {
      name: "TRANSACTION_MERKLE_TREE_SEED",
      type: "bytes",
      value:
        "[116, 114, 97, 110, 115, 97, 99, 116, 105, 111, 110, 95, 109, 101, 114, 107, 108, 101, 95, 116, 114, 101, 101]",
    },
  ],
  instructions: [
    {
