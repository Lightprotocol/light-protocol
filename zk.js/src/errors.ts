export enum UtxoErrorCode {
  ...
  UTXO_DATA_HASH_UNDEFINED = "UTXO_DATA_HASH_UNDEFINED",
  NO_PUBLIC_KEY_PROVIDED_FOR_PROGRAM_UTXO = "NO_PUBLIC_KEY_PROVIDED_FOR_PROGRAM_UTXO",
}
...
export enum CreateUtxoErrorCode {
  ...
  ACCOUNT_UNDEFINED_FOR_PRIVATE_UTXO = "ACCOUNT_UNDEFINED_FOR_PRIVATE_UTXO",
}
