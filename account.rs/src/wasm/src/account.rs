...
mod tests {
    ...
    fn assert_private_key(account: &Account) {
        let ref_private_key = [
            23, 196, 94, 157, 212, 123, 47, 180, 71, 89, 138, 223, 199, 148, 254, 165, 212, 38, 28,
            106, 138, 144, 77, 37, 23, 114, 126, 243, 187, 56, 179, 239,
        ];
    ...
    fn assert_public_key(account: &Account) {
        let ref_pubkey = [
            4, 254, 190, 180, 49, 143, 204, 13, 9, 24, 144, 85, 45, 149, 140, 120, 134, 132, 231,
            72, 52, 8, 251, 139, 9, 199, 167, 59, 81, 94, 35, 124,
        ];
