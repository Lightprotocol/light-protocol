...
use quote::quote;
use syn::{
    parse_quote, visit_mut::VisitMut, FnArg, GenericArgument, Ident, Item, ItemFn, ItemMod,
    PathArguments, Result, Stmt, Type,
};
...
impl VisitMut for LightProgramTransform {
    fn visit_item_fn_mut(&mut self, i: &mut ItemFn) {
        ...
        // Inject a `verify` instruction at the end of the function.
