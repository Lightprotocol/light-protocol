...
pub fn _process_instruction_prepare_inputs(
    ...
    if id == 40 {
        ...
        init_res_instruction(&mut account.res_x_range, &mut account.res_y_range, &mut account.res_z_range);
        ...
        maths_instruction(&mut account.res_x_range, &mut account.res_y_range, &mut account.res_z_range, &account.i_1_range, &account.x_1_range, current_index); // 1 of 256
        account.changed_variables[RES_X_RANGE_INDEX] = true;
        account.changed_variables[RES_Y_RANGE_INDEX] = true;
        account.changed_variables[RES_Z_RANGE_INDEX] = true;
        account.changed_variables[I_1_RANGE_INDEX] = true;
        ...
        maths_instruction(&mut account.res_x_range, &mut account.res_y_range, &mut account.res_z_range, &account.i_2_range, &account.x_2_range, current_index);
        account.changed_variables[RES_X_RANGE_INDEX] = true;
        account.changed_variables[RES_Y_RANGE_INDEX] = true;
        account.changed_variables[RES_Z_RANGE_INDEX] = true;
        account.changed_variables[I_2_RANGE_INDEX] = true;
        ...
        maths_instruction(&mut account.res_x_range, &mut account.res_y_range, &mut account.res_z_range, &account.i_3_range, &account.x_3_range, current_index);
        account.changed_variables[RES_X_RANGE_INDEX] = true;
        account.changed_variables[RES_Y_RANGE_INDEX] = true;
        account.changed_variables[RES_Z_RANGE_INDEX] = true;
        account.changed_variables[I_3_RANGE_INDEX] = true;
        ...
        maths_instruction(&mut account.res_x_range, &mut account.res_y_range, &mut account.res_z_range, &account.i_4_range, &account.x_4_range, current_index);
        account.changed_variables[RES_X_RANGE_INDEX] = true;
        account.changed_variables[RES_Y_RANGE_INDEX] = true;
        account.changed_variables[RES_Z_RANGE_INDEX] = true;
        account.changed_variables[I_4_RANGE_INDEX] = true;
        ...
        maths_g_ic_instruction(&mut account.g_ic_x_range, &mut account.g_ic_y_range, &mut account.g_ic_z_range, &account.res_x_range, &account.res_y_range, &account.res_z_range);
        account.changed_variables[G_IC_X_RANGE_INDEX] = true;
        account.changed_variables[G_IC_Y_RANGE_INDEX] = true;
        account.changed_variables[G_IC_Z_RANGE_INDEX] = true;
        account.changed_variables[RES_X_RANGE_INDEX] = true;
