...
func TestInclusionHappyPath26_2(t *testing.T) {
	tree := merkletree.BuildTestTree(26, 2)
	// convert tree t to json
	jsonBytes, _ := tree.MarshalJSON()
	jsonString := string(jsonBytes)
...
func TestInclusionWrongPath26_1_JSON(t *testing.T) {
	testInput := `
	{"root":["0x0"],
	"inPathIndices":[0],
	"inPathElements":[
...
func TestNonInclusionHappyPath26_1_JSON(t *testing.T) {
	...
	{"inPathElements": [
		[
		  "0x1870293e9c4572d377d13ee4d3a10bd0aadc2b2804e159a088b5b066e2afa305",
		  "0x2aeda0b6795f709a521e3ca32c7d865d64d58d100b2ac064a91a2e638354695e",
		  "0x1069673dcdb12263df301a6ff584a7ec261a44cb9dc68df067a4774460b1f1e1",
		  "0x18f43331537ee2af2e3d758d50f72106467c6eea50371dd528d57eb2b856d238",
		  "0x7f9d837cb17b0d36320ffe93ba52345f1b728571a568265caac97559dbc952a",
		  "0x2b94cf5e8746b3f5c9631f4c5df32907a699c58c94b2ad4d7b5cec1639183f55",
  ...
  "root": [
    "0x25a5c4f28064c652bb113742eedc9d1c8b5beb96d633ff4fde5e584a6534f4ec"
  ],
  "value": [
    "0x2"
  ]
