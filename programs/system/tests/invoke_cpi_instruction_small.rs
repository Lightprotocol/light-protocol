...
use light_system_program_pinocchio::{
    ...
    invoke_cpi::instruction_small::InvokeCpiInstructionSmall, CPI_CONTEXT_ACCOUNT_DISCRIMINATOR,
};
...
use invoke_cpi_instruction::{
    ...
    get_self_program_account_info, get_account_compression_program_account_info,
...
fn get_valid_cpi_context_account_info() -> AccountInfo {
    ...
    data[0..8].copy_from_slice(&CPI_CONTEXT_ACCOUNT_DISCRIMINATOR);
