...
mod compress_ctokens;
mod inputs;

pub use compress_and_close::close_for_compress_and_close;
pub use compress_ctokens::compress_ctokens;
pub use inputs::{CompressAndCloseInputs, NativeCompressionInputs};
...
pub(super) fn process_ctoken_compressions(
    ...
    let transfer_amount = compress_ctokens(compression_inputs)?;
