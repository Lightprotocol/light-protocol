...
use crate::{
    ...
    shared::owner_validation::check_authority,
};
...
#[profile]
pub fn native_compression(inputs: CTokenCompressionInputs) -> Result<Option<u64>, ProgramError> {
    ...
    match mode {
        ZCompressionMode::Compress => {
            ...
            check_authority(&mut ctoken, authority_account, amount)?;
