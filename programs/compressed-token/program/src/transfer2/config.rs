...
impl Transfer2Config {
    ...
    pub fn from_instruction_data(inputs: &ZCompressedTokenInstructionDataTransfer2) -> Result<Self, ProgramError> {
    ...
    fn calculate_lamport_totals(inputs: &ZCompressedTokenInstructionDataTransfer2) -> Result<(u64, u64), ProgramError> {
