...
#[constant]
pub const STATE_NULLIFIER_QUEUE_INDICES: u16 = 6857;
#[constant]
pub const STATE_NULLIFIER_QUEUE_VALUES: u16 = 4800;
#[constant]
...
#[constant]
pub const ADDRESS_MERKLE_TREE_CHANGELOG_INDICES: u16 = 6857;
#[constant]
pub const ADDRESS_MERKLE_TREE_CHANGELOG_VALUES: u16 = 4800;
