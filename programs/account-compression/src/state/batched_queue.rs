...
pub mod tests {
    ...
    /// 2. Functional for 2 values
    /// 3. Failing with invalid value index and batch index
    /// 4. Functional for 2 values in state ready to update tree
    /// 5. Failing in state ready with invalid value index
    /// 6. Failing with batch in state inserted
    #[test]
    fn test_value_exists_in_value_vec_present() {
        ...
        // // 4. Functional for 2 values in state ready to update tree
        // let first_batch = zero_copy_account.batches.get_mut(0).unwrap();
        // first_batch.advance_state_to_ready_to_update_tree().unwrap();
        // {
        //     assert!(zero_copy_account
        ...
        //         .is_ok());
        // }
        // // 5. Failing with invalid value index
        // {
        //     assert_eq!(
        ...
        //     );
        // }
        // // 6. Functional with batch in state inserted
        // {
        //     let first_batch = zero_copy_account.batches.get_mut(0).unwrap();
        //     first_batch.advance_state_to_inserted().unwrap();
        //     assert_eq!(
