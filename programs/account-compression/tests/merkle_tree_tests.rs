...
use account_compression::{
    ...
    processor::initialize_nullifier_queue::IndexedArrayAccount,
    sdk::{create_initialize_merkle_tree_instruction, create_insert_leaves_instruction},
    utils::constants::STATE_MERKLE_TREE_HEIGHT,
...
pub async fn nullify(
    ...
    let indexed_array =
        unsafe { get_hash_set::<u16, IndexedArrayAccount>(context, *indexed_array_pubkey).await };
