...
async fn test_create_and_update_group() {
    ...
    let update_group_authority_ix = psp_account_compression::instruction::UpdateGroupAuthority {
...
async fn test_init_and_insert_leaves_into_merkle_tree() {
    ...
    let instruction_data = psp_account_compression::instruction::InitializeConcurrentMerkleTree {
        index: 1u64,
