...
use verifying_key::VERIFYINGKEY_PUBLIC_TRANSACTION10_IN2_OUT_MAIN;

declare_id!("49SXdU5npUY5tqajhohVkQNTWYPPaTeMy6HFH4VLmA5V");
...
#[constant]
pub const PROGRAM_ID: &str = "49SXdU5npUY5tqajhohVkQNTWYPPaTeMy6HFH4VLmA5V";

#[program]
pub mod light_public_psp10in2out {
    ...
    pub fn shielded_transfer_first<'info>(
        ...
        let input = TransactionInput {
            ...
            pool_type: &[0u8; 32],
            verifyingkey: &VERIFYINGKEY_PUBLIC_TRANSACTION10_IN2_OUT_MAIN,
        };
