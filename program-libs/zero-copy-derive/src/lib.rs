...
mod tests {
    ...
    fn test_compressed_account_struct() {
        ...
        assert!(normalized_result
            .contains("impl<'a>light_zero_copy::borsh::Deserialize<'a>forCompressedAccount"));
        ...
        let test_cases = vec![
            ...
            TestCase {
                ...
                assertions: vec![
                    ...
                    ("impl < 'a > light_zero_copy :: borsh :: Deserialize < 'a > for EmptyStruct", true),
                ],
            },
            ...
            TestCase {
                ...
                assertions: vec![
                    ...
                    ("pub b : < Option < u32 > as light_zero_copy :: borsh :: Deserialize < 'a >> :: Output", true),
