...
/// Size of a Token account with embedded compression info (no extensions).
/// TokenZeroCopy includes: SPL token layout (165) + account_type (1) + decimal_option_prefix (1)
