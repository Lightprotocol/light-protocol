//! Optimized top-up lamports calculation for Token accounts.
...
/// Minimum size for Token with Compressible extension as first extension.
...
/// Calculate top-up lamports directly from Token account bytes.
