...
use crate::{
    constants::{CTOKEN_PROGRAM_ID, POOL_SEED, RESTRICTED_POOL_SEED},
...
// ============================================================================
// SPL interface PDA derivation (uses CTOKEN_PROGRAM_ID)
// ============================================================================
...
pub fn find_spl_interface_pda_with_index(
    ...
    let program_id = Pubkey::from(CTOKEN_PROGRAM_ID);
