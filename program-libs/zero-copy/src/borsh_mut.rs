...
impl<'a> DeserializeMut<'a> for zerocopy::little_endian::U16 {
    ...
    fn zero_copy_at_mut(
        ...
        Ok(Ref::<&mut [u8], zerocopy::little_endian::U16>::from_prefix(
            bytes,
        )?)
    }
}
...
impl<'a> DeserializeMut<'a> for zerocopy::little_endian::U32 {
    ...
    fn zero_copy_at_mut(
        ...
        Ok(Ref::<&mut [u8], zerocopy::little_endian::U32>::from_prefix(
            bytes,
        )?)
    }
}
...
impl<'a> DeserializeMut<'a> for zerocopy::little_endian::U64 {
    ...
    fn zero_copy_at_mut(
        ...
        Ok(Ref::<&mut [u8], zerocopy::little_endian::U64>::from_prefix(
            bytes,
        )?)
    }
}
